...
public:
  ...
  virtual void
  OnRtnMarketData(CTORATstpMarketDataField *pMarketDataField) override;
...
private:
  ...
  DllHandle _hInst;
  typedef HuaXParserApi *(*HuaXCreater)(const TTORATstpMDSubModeType &,
                                        const TTORATstpMDSubModeType &);
