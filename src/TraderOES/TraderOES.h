...
public:
  ...
  void handle_rsp_account(SMsgHeadT *pMsgHead, void *pMsgItem,
                          OesQryCursorT *pQryCursor);
  void handle_rsp_orders(SMsgHeadT *pMsgHead, void *pMsgItem,
                         OesQryCursorT *pQryCursor);
  void handle_rsp_trades(SMsgHeadT *pMsgHead, void *pMsgItem,
                         OesQryCursorT *pQryCursor);
  void handle_rsp_positions(SMsgHeadT *pMsgHead, void *pMsgItem,
                            OesQryCursorT *pQryCursor);
