...
public:
   ...
   *	code	管理的合约代码
   */
  virtual void init(ExecuteContext *ctx, const char *stdCode,
                    WTSVariant *cfg) override;
...
private:
  ...
  double _max_cancel_time{
      3}; // 最大撤单次数，如果超过这个次数仍然未撤单，则说明是错单
