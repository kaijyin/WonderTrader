...
WtLocalExecuter::WtLocalExecuter(WtExecuterFactory *factory, const char *name,
...
ExecuteUnitPtr WtLocalExecuter::getUnit(const char *stdCode,
...
WTSTickSlice *WtLocalExecuter::getTicks(const char *stdCode, uint32_t count,
                                        uint64_t etime /* = 0 */) {
  if (_data_mgr == NULL)
    return NULL;
...
double WtLocalExecuter::getPosition(const char *stdCode,
                                    bool validOnly /* = true */,
                                    int32_t flag /* = 3 */) {
  if (NULL == _trader)
    return 0.0;
...
void WtLocalExecuter::set_position(
...
void WtLocalExecuter::on_trade(uint32_t localid, const char *stdCode,
...
void WtLocalExecuter::on_order(uint32_t localid, const char *stdCode,
                               bool isBuy, double totalQty, double leftQty,
                               double price, bool isCanceled /* = false */) {
  ExecuteUnitPtr unit = getUnit(stdCode, false);
  if (unit == NULL)
    return;
...
void WtLocalExecuter::on_entrust(uint32_t localid, const char *stdCode,
...
void WtLocalExecuter::on_account(const char *currency, double prebalance,
...
void WtLocalExecuter::on_position(const char *stdCode, bool isLong,
