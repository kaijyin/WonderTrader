...
WtHftEngine::WtHftEngine() : _cfg(NULL), _tm_ticker(NULL) {}
...
void WtHftEngine::init(WTSVariant *cfg, IBaseDataMgr *bdMgr, WtDtMgr *dataMgr,
...
void WtHftEngine::on_bar(const char *stdCode, const char *period,
...
WTSOrdQueSlice *WtHftEngine::get_order_queue_slice(uint32_t sid,
                                                   const char *code,
                                                   uint32_t count) {
  return _data_mgr->get_order_queue_slice(code, count);
}

WTSOrdDtlSlice *WtHftEngine::get_order_detail_slice(uint32_t sid,
                                                    const char *code,
                                                    uint32_t count) {
  return _data_mgr->get_order_detail_slice(code, count);
}

WTSTransSlice *WtHftEngine::get_transaction_slice(uint32_t sid,
                                                  const char *code,
                                                  uint32_t count) {
