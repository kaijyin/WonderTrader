...
WtDistExecuter::WtDistExecuter(const char *name) : IExecCommand(name) {}
...
void WtDistExecuter::set_position(
...
void WtDistExecuter::on_position_changed(const char *stdCode,
                                         double targetPos) {
  targetPos *= _scale;
