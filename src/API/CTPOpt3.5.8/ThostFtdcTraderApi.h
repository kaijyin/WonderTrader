...
public:
  ...
  /// 锁定应答
  virtual void OnRspLockInsert(CThostFtdcInputLockField *pInputLock,
                               CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) {};
  ...
  /// 请求查询锁定应答
  virtual void OnRspQryLock(CThostFtdcLockField *pLock,
                            CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                            bool bIsLast) {};

  /// 请求查询锁定证券仓位应答
  virtual void OnRspQryLockPosition(CThostFtdcLockPositionField *pLockPosition,
                                    CThostFtdcRspInfoField *pRspInfo,
                                    int nRequestID, bool bIsLast) {};

  /// 请求查询ETF期权合约手续费响应
  virtual void OnRspQryETFOptionInstrCommRate(
      CThostFtdcETFOptionInstrCommRateField *pETFOptionInstrCommRate,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 请求查询投资者分级
  virtual void
  OnRspQryInvestorLevel(CThostFtdcInvestorLevelField *pInvestorLevel,
                        CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) {};

  /// 请求查询E+1日行权冻结响应
  virtual void OnRspQryExecFreeze(CThostFtdcExecFreezeField *pExecFreeze,
                                  CThostFtdcRspInfoField *pRspInfo,
                                  int nRequestID, bool bIsLast) {};
  ...
  /// 锁定错误通知
  virtual void OnErrRtnLockInsert(CThostFtdcInputLockField *pInputLock,
                                  CThostFtdcRspInfoField *pRspInfo) {};
  ...
  /// 银行发起第三方存管业务开户确认通知
  virtual void OnRtnResOpenAccConfirmTpdByBank(
      CThostFtdcResOpenAccConfirmTpdField *pResOpenAccConfirmTpd) {};

  /// 期货发起第三方存管业务开户预指定应答
  virtual void OnRspReserveOpenAccountTpdByFuture(
      CThostFtdcReqReserveOpenAccountTpdField *pReqReserveOpenAccountTpd,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 期货发起第三方存管证券资金结息应答
  virtual void OnRspSecuritiesDepositInterestByFuture(
      CThostFtdcReqSecuritiesDepositInterestField
          *pReqSecuritiesDepositInterest,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 期货发起日终文件就绪应答
  virtual void OnRspDayEndFileReadyByFuture(
      CThostFtdcReqDayEndFileReadyField *pReqDayEndFileReady,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 行权指令合并录入请求响应
  virtual void OnRspExecCombineOrderInsert(
      CThostFtdcInputExecCombineOrderField *pInputExecCombineOrder,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 行权指令合并操作请求响应
  virtual void OnRspExecCombineOrderAction(
      CThostFtdcInputExecCombineOrderActionField *pInputExecCombineOrderAction,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

  /// 请求查询行权指令合并响应
  virtual void
  OnRspQryExecCombineOrder(CThostFtdcExecCombineOrderField *pExecCombineOrder,
                           CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {};

  /// 行权指令合并操作错误回报
  virtual void OnErrRtnExecCombineOrderAction(
      CThostFtdcExecCombineOrderActionField *pExecCombineOrderAction,
      CThostFtdcRspInfoField *pRspInfo) {};

  /// 行权指令合并录入错误回报
  virtual void OnErrRtnExecCombineOrderInsert(
      CThostFtdcInputExecCombineOrderField *pInputExecCombineOrder,
      CThostFtdcRspInfoField *pRspInfo) {};

  /// 行权指令合并通知
  virtual void
  OnRtnExecCombineOrder(CThostFtdcExecCombineOrderField *pExecCombineOrder) {};
};
...
public:
  ...
  /// 锁定请求
  virtual int ReqLockInsert(CThostFtdcInputLockField *pInputLock,
                            int nRequestID) = 0;
  ...
  /// 请求查询锁定证券仓位
  virtual int
  ReqQryLockPosition(CThostFtdcQryLockPositionField *pQryLockPosition,
                     int nRequestID) = 0;

  /// 请求查询ETF期权合约手续费
  virtual int ReqQryETFOptionInstrCommRate(
      CThostFtdcQryETFOptionInstrCommRateField *pQryETFOptionInstrCommRate,
      int nRequestID) = 0;

  /// 请求查询投资者分级
  virtual int
  ReqQryInvestorLevel(CThostFtdcQryInvestorLevelField *pQryInvestorLevel,
                      int nRequestID) = 0;

  /// 请求查询E+1日行权冻结
  virtual int ReqQryExecFreeze(CThostFtdcQryExecFreezeField *pQryExecFreeze,
                               int nRequestID) = 0;
  ...
  /// 期货发起第三方存管业务开户预指定请求
  virtual int ReqReserveOpenAccountTpdByFuture(
      CThostFtdcReqReserveOpenAccountTpdField *pReqReserveOpenAccountTpd,
      int nRequestID) = 0;

  /// 期货发起第三方存管证券资金结息请求
  virtual int ReqSecuritiesDepositInterestByFuture(
      CThostFtdcReqSecuritiesDepositInterestField
          *pReqSecuritiesDepositInterest,
      int nRequestID) = 0;

  /// 期货发起日终文件就绪请求
  virtual int ReqDayEndFileReadyByFuture(
      CThostFtdcReqDayEndFileReadyField *pReqDayEndFileReady,
      int nRequestID) = 0;

  /// 行权指令合并录入请求
  virtual int ReqExecCombineOrderInsert(
      CThostFtdcInputExecCombineOrderField *pInputExecCombineOrder,
      int nRequestID) = 0;

  /// 行权指令合并操作请求
  virtual int ReqExecCombineOrderAction(
      CThostFtdcInputExecCombineOrderActionField *pInputExecCombineOrderAction,
      int nRequestID) = 0;

  /// 请求查询行权指令合并
  virtual int ReqQryExecCombineOrder(
