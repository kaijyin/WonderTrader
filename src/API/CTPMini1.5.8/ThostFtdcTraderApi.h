...
public:
  ...
  /// 请求查询申请组合合约响应
  virtual void
  OnRspQryCombInstrument(CThostFtdcCombInstrumentField *pCombInstrument,
                         CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                         bool bIsLast) {};
  ...
  /// 请求查询组合单腿汇总表响应
  virtual void OnRspQryInvestorPositionForComb(
      CThostFtdcInvestorPositionForCombField *pCombAction,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
  ...
  /// 请求查询合约状态响应
  virtual void
  OnRspQryInstrumentStatus(CThostFtdcInstrumentStatusField *pInstrumentStatus,
                           CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {};
...
public:
  ...
  /// 用户加密登录请求
  virtual int
  ReqUserLoginEncrypt(CThostFtdcReqUserLoginField *pReqUserLoginField,
                      int nRequestID) = 0;
  ...
  /// 请求查询申请组合合约
  virtual int
  ReqQryCombInstrument(CThostFtdcQryCombInstrumentField *pQryCombInstrument,
                       int nRequestID) = 0;

  /// 请求单腿持仓汇总
  virtual int ReqQryInvestorPositionForComb(
      CThostFtdcQryInvestorPositionForCombField *pQryIPForComb,
      int nRequestID) = 0;
