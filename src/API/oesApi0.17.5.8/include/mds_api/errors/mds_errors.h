...
/** 1039, 非法的指令类型 */
#define MDSERR_ILLEGAL_CMD_TYPE (&__ERRS_oesApiErrors[38])
/** 1040, 数据已存在 */
#define MDSERR_EXIST (&__ERRS_oesApiErrors[39])
/** 1041, 需要再次尝试 */
#define MDSERR_TRY_AGAIN (&__ERRS_oesApiErrors[40])
/** 1042, 非法的委托方式 */
#define MDSERR_ILLEGAL_ENTRUST_WAY (&__ERRS_oesApiErrors[41])
/* -------------------------           */
