 ...
 */
void *MdsParser_EncodeReq(SMsgHeadT *pReqHead,
 ...
 */
MdsMktReqMsgBodyT *MdsParser_DecodeReq(SMsgHeadT *pReqHead,
                                       const void *pMsgBody,
 ...
 * @return  编码后的消息体数据; NULL：编码失败
 */
void *MdsParser_EncodeRsp(SMsgHeadT *pRspHead,
 ...
 * @return  解码后的消息体数据; NULL：解析失败
 */
MdsMktRspMsgBodyT *MdsParser_DecodeRsp(SMsgHeadT *pRspHead,
                                       const void *pMsgBody,
 ...
 * @return  行情数据类型字符串
 */
const char *MdsParser_GetMdStreamIdString(uint8 exchId, uint8 bodyType,
                                          uint8 subStreamType);
/* -------------------------           */
