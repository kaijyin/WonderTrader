 ...
 * float128型数值转为字符串
 */
char *SStr_FixedLdtoStr(char *pBuf, float128 num, int32 precision, int32 scale);
 ...
 * @return  转换后的数值
 */
static __inline long SStr_StrtoL10(const char *pValue) {
 ...
 * @return  转换后的数值
 */
static __inline long SStr_StrtoL10Nullable(const char *pValue) {
 ...
 * @return  转换后的数值
 */
static __inline int64 SStr_StrtoLL10(const char *pValue) {
 ...
 * @return  转换后的数值
 */
static __inline int64 SStr_StrtoLL10Nullable(const char *pValue) {
  if (__spk_unlikely(!pValue)) {
    return 0;
  }
 ...
 * @return  转换后的数值
 */
static __inline int32 SStr_StrtoI10(const char *pValue) {
 ...
 * @return  转换后的数值
 */
static __inline int32 SStr_StrtoI10Nullable(const char *pValue) {
  if (__spk_unlikely(!pValue)) {
    return 0;
  }
 ...
 * @return  转换后的数值
 */
static __inline long SStr_FixedStrtoL10(const char *pValue, int32 len) {
  char __tmpBuf[32];
 ...
 * @return  转换后的数值
 */
static __inline int64 SStr_FixedStrtoLL10(const char *pValue, int32 len) {
  char __tmpBuf[32];
 ...
 * @return  转换后的数值
 */
static __inline int32 SStr_FixedStrtoI10(const char *pValue, int32 len) {
