 ...
 * 格式化日期/时间
 */
char *STime_FormatTime(char *pBuf, const struct tm *pTm, const char *pFormat);
...
#define __STIME_DiffTimevalMs(P_TV1, P_TV2)                                    \
  ((int64)((P_TV2)->tv_sec - (P_TV1)->tv_sec) * 1000 +                         \
   SPK_UNSIGNED_ROUND_TIMES((P_TV2)->tv_usec - (P_TV1)->tv_usec, 1000))
...
#define __STIME_DiffTimevalUs(P_TV1, P_TV2)                                    \
  ((int64)((P_TV2)->tv_sec - (P_TV1)->tv_sec) * 1000000 + (P_TV2)->tv_usec -   \
   (P_TV1)->tv_usec)
...
#define __STIME_DiffTimevalUsFloat(P_TV1, P_TV2)                               \
  ((double)((P_TV2)->tv_sec - (P_TV1)->tv_sec) * 1000000 + (P_TV2)->tv_usec -  \
   (P_TV1)->tv_usec)
/* -------------------------           */
...
#define __STIME_DiffTimespecMs(P_TS1, P_TS2)                                   \
  ((int64)((P_TS2)->tv_sec - (P_TS1)->tv_sec) * 1000 +                         \
   SPK_UNSIGNED_ROUND_TIMES((P_TS2)->tv_nsec - (P_TS1)->tv_nsec, 1000000))
...
#define __STIME_DiffTimespecUs(P_TS1, P_TS2)                                   \
  ((int64)((P_TS2)->tv_sec - (P_TS1)->tv_sec) * 1000000 +                      \
   SPK_UNSIGNED_ROUND_TIMES((P_TS2)->tv_nsec - (P_TS1)->tv_nsec, 1000))
 ...
 * 转换并返回tm结构的时间
 *
 * @param       unixSecs    number of seconds since 1970-01-01 00:00:00 +0000
 * (UTC)
 ...
 */
static __inline struct tm *__STime_FastSecondToDate2(const int64 unixSecs,
                                                     struct tm *pResult,
                                                     int32 timeZone) {
 ...
 * @see         http://www.cnblogs.com/westfly/p/5139645.html
 */
static __inline struct tm *__STime_FastSecondToDate(const int64 unixSecs,
                                                    struct tm *pResult) {
 ...
 * @return      tm结构的时间
 */
static __inline struct tm *__STime_LocaltimeR(const time_t *pUnixSecs,
                                              struct tm *pResult) {
 ...
 * 返回当前系统时间
 *
 * @return  time_t          number of seconds since 1970-01-01 00:00:00 +0000
 * (UTC)
 * @see     time()
 */
static __inline time_t STime_GetSysTime() { return time((time_t *)NULL); }
 ...
 */
static __inline struct tm *STime_GetCurrentTm(struct tm *pOutTm) {
 ...
 * @return      tm结构的时间
 */
static __inline struct tm *STime_GetTmBySeconds(struct tm *pOutTm,
                                                int64 unixSecs) {
 ...
 * @see         gettimeofday()
 */
static __inline STimevalT *STime_GetTimeOfDay(STimevalT *pTv) {
  SLOG_ASSERT(pTv);
 ...
 * @see         gettimeofday()
 */
static __inline STimeval32T *STime_GetTimeOfDay32(STimeval32T *pTv) {
  STimevalT tv = {0, 0};
 ...
 */
static __inline STimespecT *STime_GetClockTime(STimespecT *pTs) {
 ...
 * @see         clock_gettime()
 */
static __inline STimespec32T *STime_GetClockTime32(STimespec32T *pTs) {
  STimespecT ts = {0, 0};
 ...
 */
static __inline int64 STime_GetMillisecondsTime() {
  STimevalT tv = {0, 0};
 ...
 */
static __inline int64 STime_DiffMillisecond(const STimevalT *pTv1,
                                            const STimevalT *pTv2) {
 ...
 * @return  相差的毫秒数 (pTv2 - pTv1)
 */
static __inline int64 STime_DiffMillisecond32(const STimeval32T *pTv1,
                                              const STimeval32T *pTv2) {
  SLOG_ASSERT(pTv1 && pTv2);
  return __STIME_DiffTimevalMs(pTv1, pTv2);
}
 ...
 * @return  相差的毫秒数 (pTv2 - pTv1)
 */
static __inline double STime_DiffMillisecondFloat(const STimevalT *pTv1,
                                                  const STimevalT *pTv2) {
  SLOG_ASSERT(pTv1 && pTv2);
 ...
 * @return  相差的毫秒数 (pTv2 - pTv1)
 */
static __inline double STime_DiffMillisecondFloat32(const STimeval32T *pTv1,
                                                    const STimeval32T *pTv2) {
  SLOG_ASSERT(pTv1 && pTv2);
  return __STIME_DiffTimevalMsFloat(pTv1, pTv2);
}
 ...
 */
static __inline int64 STime_DiffMicrosecond(const STimevalT *pTv1,
                                            const STimevalT *pTv2) {
  SLOG_ASSERT(pTv1 && pTv2);
 ...
 * @return  相差的微秒数 (pTv2 - pTv1)
 */
static __inline int64 STime_DiffMicrosecond32(const STimeval32T *pTv1,
                                              const STimeval32T *pTv2) {
  SLOG_ASSERT(pTv1 && pTv2);
  return __STIME_DiffTimevalUs(pTv1, pTv2);
}
 ...
 */
static __inline int64 STime_DiffTimespecNs(const STimespecT *pTs1,
                                           const STimespecT *pTs2) {
 ...
 * @return  相差的纳秒数 (pTs2 - pTs1)
 */
static __inline int64 STime_DiffTimespecNs32(const STimespec32T *pTs1,
                                             const STimespec32T *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
  return __STIME_DiffTimespecNs(pTs1, pTs2);
}
 ...
 */
static __inline int64 STime_DiffTimespecUs(const STimespecT *pTs1,
                                           const STimespecT *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
 ...
 * @return  相差的微秒数 (pTs2 - pTs1)
 */
static __inline int64 STime_DiffTimespecUs32(const STimespec32T *pTs1,
                                             const STimespec32T *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
  return __STIME_DiffTimespecUs(pTs1, pTs2);
}
 ...
 * @return  相差的微秒数 (pTs2 - pTs1)
 */
static __inline double STime_DiffTimespecUsFloat(const STimespecT *pTs1,
                                                 const STimespecT *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
 ...
 * @return  相差的微秒数 (pTs2 - pTs1)
 */
static __inline double STime_DiffTimespecUsFloat32(const STimespec32T *pTs1,
                                                   const STimespec32T *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
  return __STIME_DiffTimespecUsFloat(pTs1, pTs2);
}
 ...
 */
static __inline int64 STime_DiffTimespecMs(const STimespecT *pTs1,
                                           const STimespecT *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
 ...
 * @return  相差的毫秒数 (pTs2 - pTs1)
 */
static __inline int64 STime_DiffTimespecMs32(const STimespec32T *pTs1,
                                             const STimespec32T *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
  return __STIME_DiffTimespecMs(pTs1, pTs2);
}
 ...
 * @return  相差的毫秒数 (pTs2 - pTs1)
 */
static __inline double STime_DiffTimespecMsFloat(const STimespecT *pTs1,
                                                 const STimespecT *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
 ...
 * @return  相差的毫秒数 (pTs2 - pTs1)
 */
static __inline double STime_DiffTimespecMsFloat32(const STimespec32T *pTs1,
                                                   const STimespec32T *pTs2) {
  SLOG_ASSERT(pTs1 && pTs2);
  return __STIME_DiffTimespecMsFloat(pTs1, pTs2);
}
 ...
 */
static __inline BOOL STime_IsLeapYear(int32 iYear) {
  return ((iYear % 4 == 0 && iYear % 100 != 0) || iYear % 400 == 0) ? TRUE
                                                                    : FALSE;
}
 ...
 *          <=0 失败
 */
static __inline int32 STime_GetMonthDays(int32 year, int32 month) {
  static const int32 normalDays[] = {0,  31, 28, 31, 30, 31, 30,
                                     31, 31, 30, 31, 30, 31};
  static const int32 leapYearDays[] = {0,  31, 29, 31, 30, 31, 30,
                                       31, 31, 30, 31, 30, 31};
 ...
 * @return  年份
 */
static __inline int32 STime_GetYearOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
 ...
 * @return  月份
 */
static __inline int32 STime_GetMonthOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
  return pTm->tm_mon + 1;
}
 ...
 * @return  本月第几日
 */
static __inline int32 STime_GetDayOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
  return pTm->tm_mday;
}
 ...
 * @return  小时数
 */
static __inline int32 STime_GetHourOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
  return pTm->tm_hour;
}
 ...
 * @return  分钟数
 */
static __inline int32 STime_GetMinuteOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
  return pTm->tm_min;
}
 ...
 * @return  秒数
 */
static __inline int32 STime_GetSecondOfTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
  return pTm->tm_sec;
}
 ...
 * @return  年份
 */
static __inline int32 STime_GetYearOfIntDate(int32 iDate) {
  return iDate / 10000;
}
 ...
 * @return  月份
 */
static __inline int32 STime_GetMonthOfIntDate(int32 iDate) {
 ...
 * @return  本月第几日
 */
static __inline int32 STime_GetDayOfIntDate(int32 iDate) { return iDate % 100; }
 ...
 * @return  小时数
 */
static __inline int32 STime_GetHourOfIntTime(int32 iTime) {
  return iTime / 10000;
}
 ...
 * @return  分钟数
 */
static __inline int32 STime_GetMinuteOfIntTime(int32 iTime) {
 ...
 * @return  秒数
 */
static __inline int32 STime_GetSecondOfIntTime(int32 iTime) {
  return iTime % 100;
}
 ...
 * @return  小时数
 */
static __inline int32 STime_GetHourOfIntTimeMs(int32 iTime) {
 ...
 */
static __inline int32 STime_ConvertIntTimeToDailySeconds(int32 iTime) {
  return STime_GetHourOfIntTime(iTime) * 3600 +
         STime_GetMinuteOfIntTime(iTime) * 60 + STime_GetSecondOfIntTime(iTime);
}
 ...
 */
static __inline int32 STime_ConvertDailySecondsToIntTime(int32 seconds) {
 ...
 * @return  分钟数
 */
static __inline int32 STime_GetMinuteOfIntTimeMs(int32 iTime) {
 ...
 * @return  秒数
 */
static __inline int32 STime_GetSecondOfIntTimeMs(int32 iTime) {
 ...
 * @return  毫秒数
 */
static __inline int32 STime_GetMillisecondOfIntTimeMs(int32 iTime) {
  return iTime % 1000;
}
 ...
 * @return  相差的天数
 */
static __inline int32 STime_DiffIntDays(int32 iBeginDate, int32 iEndDate) {
  int32 beginYear = 0;
  int32 beginMonth = 0;
  int32 beginDay = 0;
  int32 endYear = 0;
 ...
 * @return  相差的秒数
 */
static __inline int32 STime_DiffIntTime(int32 beginTime, int32 endTime) {
 ...
 * @return  相差的毫秒数
 */
static __inline int32 STime_DiffIntTimeMs(int32 beginTimeMs, int32 endTimeMs) {
  int32 beginMs = 0;
  int32 endMs = 0;
 ...
 */
static __inline char *STime_FormatTmToDate(char *pBuf, const struct tm *pTm) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 9, "%d%02d%02d", pTm->tm_year + 1900, pTm->tm_mon + 1,
           pTm->tm_mday);
  return pBuf;
}
 ...
 */
static __inline char *STime_FormatTmToDate2(char *pBuf, const struct tm *pTm) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 11, "%d-%02d-%02d", pTm->tm_year + 1900, pTm->tm_mon + 1,
           pTm->tm_mday);
  return pBuf;
}
 ...
 * @return      yyyy*mm*dd格式的日期字符串
 */
static __inline char *STime_FormatTmToDate3(char *pBuf, const struct tm *pTm,
                                            char delimChar) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 11, "%d%c%02d%c%02d", pTm->tm_year + 1900, delimChar,
           pTm->tm_mon + 1, delimChar, pTm->tm_mday);
  return pBuf;
}
 ...
 */
static __inline char *STime_FormatTmToTime(char *pBuf, const struct tm *pTm) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 7, "%02d%02d%02d", pTm->tm_hour, pTm->tm_min, pTm->tm_sec);
  return pBuf;
}
 ...
 */
static __inline char *STime_FormatTmToTime2(char *pBuf, const struct tm *pTm) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 9, "%02d:%02d:%02d", pTm->tm_hour, pTm->tm_min, pTm->tm_sec);
  return pBuf;
}
 ...
 * @return      hh*mm*ss格式的时间字符串
 */
static __inline char *STime_FormatTmToTime3(char *pBuf, const struct tm *pTm,
                                            char delimChar) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 9, "%02d%c%02d%c%02d", pTm->tm_hour, delimChar, pTm->tm_min,
           delimChar, pTm->tm_sec);
  return pBuf;
}
 ...
 */
static __inline char *STime_FormatTmToTimestamp(char *pBuf,
                                                const struct tm *pTm) {
  SLOG_ASSERT(pBuf && pTm);
  snprintf(pBuf, 18, "%d%02d%02d-%02d:%02d:%02d", pTm->tm_year + 1900,
 ...
 */
static __inline char *STime_FormatUnixTimestamp(char *pBuf, int64 unixSecs) {
  struct tm tm1;
  ...
  snprintf(pBuf, 18, "%d%02d%02d-%02d:%02d:%02d", tm1.tm_year + 1900,
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS"的17位时间戳字符串
 */
static __inline char *STime_FormatTimevalSecs(char *pBuf,
                                              const STimevalT *pTv) {
  struct tm tm1;
 ...
 */
static __inline char *STime_FormatTimevalMs(char *pBuf, const STimevalT *pTv) {
  struct tm tm1;
  ...
  snprintf(pBuf, 22, "%d%02d%02d-%02d:%02d:%02d.%03d", tm1.tm_year + 1900,
           tm1.tm_mon + 1, tm1.tm_mday, tm1.tm_hour, tm1.tm_min, tm1.tm_sec,
 ...
 */
static __inline char *STime_FormatTimevalMs23(char *pBuf,
                                              const STimevalT *pTv) {
  struct tm tm1;
  ...
  snprintf(pBuf, 24, "%d-%02d-%02d %02d:%02d:%02d.%03d", tm1.tm_year + 1900,
           tm1.tm_mon + 1, tm1.tm_mday, tm1.tm_hour, tm1.tm_min, tm1.tm_sec,
           (int32)(pTv->tv_usec / 1000));
  return pBuf;
}
 ...
 */
static __inline char *STime_FormatTimevalMs4(char *pBuf, const STimevalT *pTv) {
  struct tm tm1;
  ...
  snprintf(pBuf, 23, "%d%02d%02d-%02d:%02d:%02d.%04d", tm1.tm_year + 1900,
           tm1.tm_mon + 1, tm1.tm_mday, tm1.tm_hour, tm1.tm_min, tm1.tm_sec,
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS"的17位时间戳字符串
 */
static __inline char *STime_FormatTimespecSecs(char *pBuf,
                                               const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS.sss"的21位时间戳字符串
 */
static __inline char *STime_FormatTimespecMs(char *pBuf,
                                             const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return      形如"YYYY-MM-DD HH:mm:SS.sss"的23位时间戳字符串
 */
static __inline char *STime_FormatTimespecMs23(char *pBuf,
                                               const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS.ssss"的22位时间戳字符串
 */
static __inline char *STime_FormatTimespecMs4(char *pBuf,
                                              const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS"的17位时间戳字符串
 */
static __inline char *STime_GetFormattedTimestamp(char *pBuf) {
  struct tm tm1;
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS.sss"的21位时间戳字符串
 */
static __inline char *STime_GetFormattedTimestampMs(char *pBuf) {
  STimevalT tv;
 ...
 * @return      形如"YYYY-MM-DD HH:mm:SS.sss"的23位时间戳字符串
 */
static __inline char *STime_GetFormattedTimestampMs23(char *pBuf) {
  STimevalT tv;
 ...
 * @return      形如"YYYYMMDD-HH:mm:SS.ssss"的22位时间戳字符串
 */
static __inline char *STime_GetFormattedTimestampMs4(char *pBuf) {
  STimevalT tv;
 ...
 */
static __inline int32 STime_GetIntDateFromTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
 ...
 */
static __inline int32 STime_GetIntTimeFromTm(const struct tm *pTm) {
  SLOG_ASSERT(pTm);
 ...
 * @return      tm 结构
 */
static __inline struct tm *STime_ConvertIntToTm(struct tm *pOutTm, int32 iDate,
                                                int32 iTime) {
  SLOG_ASSERT(pOutTm);
 ...
 */
static __inline int64 STime_ConvertIntToSeconds(int32 iDate, int32 iTime) {
  struct tm tm1;
 ...
 */
static __inline int32 STime_GetIntDate() {
  struct tm tm1;
 ...
 */
static __inline int32 STime_GetIntTime() {
  struct tm tm1;
 ...
 */
static __inline int32 STime_GetIntTimeMs() {
  struct tm tm1;
  STimevalT tv;
 ...
 * @return  int32 当前日期, 格式为YYYYMMDD
 */
static __inline int32 STime_GetIntDateFromSeconds(int64 time) {
  struct tm tm1;
 ...
 */
static __inline int32 STime_GetIntTimeFromSeconds(int64 time) {
  struct tm tm1;
 ...
 * @return  相对与UTC 1970年1月1日零时的毫秒数
 */
static __inline int64 STime_GetMillisecondsFromTimeval(const STimevalT *pTv) {
  SLOG_ASSERT(pTv);
 ...
 * @return  相对与UTC 1970年1月1日零时的毫秒数
 */
static __inline int64 STime_GetMillisecondsFromTimespec(const STimespecT *pTs) {
  SLOG_ASSERT(pTs);
 ...
 * @return  int32 当前日期, 格式为YYYYMMDD
 */
static __inline int32 STime_GetIntDateFromTimeval(const STimevalT *pTv) {
  struct tm tm1;
 ...
 * @return  int32 当前日期, 格式为YYYYMMDD
 */
static __inline int32 STime_GetIntDateFromTimeval32(const STimeval32T *pTv) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(秒), 格式为HHMMSS
 */
static __inline int32 STime_GetIntTimeFromTimeval(const STimevalT *pTv) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(秒), 格式为HHMMSS
 */
static __inline int32 STime_GetIntTimeFromTimeval32(const STimeval32T *pTv) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(毫秒), 格式为HHMMSSsss
 */
static __inline int32 STime_GetIntTimeMsFromTimeval(const STimevalT *pTv) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(毫秒), 格式为HHMMSSsss
 */
static __inline int32 STime_GetIntTimeMsFromTimeval32(const STimeval32T *pTv) {
  struct tm tm1;
 ...
 */
static __inline int64 STime_GetIntTimestampFromTimeval(const STimevalT *pTv) {
  struct tm tm1;
 ...
 */
static __inline void STime_GetIntTimestamp2FromTimeval(const STimevalT *pTv,
                                                       int32 *pOutDate,
                                                       int32 *pOutTimeMs) {
  struct tm tm1;
 ...
 * @param[out]  pOutTimeMs  输出当前时间(毫秒), 格式为HHMMSSsss
 */
static __inline void STime_GetIntTimestamp2FromTimeval32(const STimeval32T *pTv,
                                                         int32 *pOutDate,
                                                         int32 *pOutTimeMs) {
  struct tm tm1;
 ...
 * @return  int32 当前日期, 格式为YYYYMMDD
 */
static __inline int32 STime_GetIntDateFromTimespec(const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return  int32 当前日期, 格式为YYYYMMDD
 */
static __inline int32 STime_GetIntDateFromTimespec32(const STimespec32T *pTs) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(秒), 格式为HHMMSS
 */
static __inline int32 STime_GetIntTimeFromTimespec(const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(秒), 格式为HHMMSS
 */
static __inline int32 STime_GetIntTimeFromTimespec32(const STimespec32T *pTs) {
  struct tm tm1;
 ...
 * @return  int32 当前时间(毫秒), 格式为HHMMSSsss
 */
static __inline int32 STime_GetIntTimeMsFromTimespec(const STimespecT *pTs) {
  struct tm tm1;

  SLOG_ASSERT(pTs);
  STime_GetTmBySeconds(&tm1, pTs->tv_sec);

  return STime_GetIntTimeFromTm(&tm1) * 1000 + (int32)(pTs->tv_nsec / 1000000);
}
 ...
 * @return  int64 当前时间, 格式为YYYYMMDDHHMMSSsss
 */
static __inline int64 STime_GetIntTimestampFromTimespec(const STimespecT *pTs) {
  struct tm tm1;
 ...
 * @param[out]  pOutTimeMs  输出当前时间(毫秒), 格式为HHMMSSsss
 */
static __inline void STime_GetIntTimestamp2FromTimespec(const STimespecT *pTs,
                                                        int32 *pOutDate,
                                                        int32 *pOutTimeMs) {
  struct tm tm1;
  ...
  *pOutDate = STime_GetIntDateFromTm(&tm1);
  *pOutTimeMs =
      STime_GetIntTimeFromTm(&tm1) * 1000 + (int32)(pTs->tv_nsec / 1000000);
}
