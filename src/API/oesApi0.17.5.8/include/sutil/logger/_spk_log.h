 ...
 */
#define SLOG_TRACE(...)                                                        \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_TRACE, __VA_ARGS__)
#else
#define SLOG_TRACE(...)
#endif
...
#define SLOG_DEBUG(...)                                                        \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_DEBUG, __VA_ARGS__)
#else
#define SLOG_DEBUG(...)
#endif
...
#define SLOG_INFO(...)                                                         \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_INFO, __VA_ARGS__)
...
#define SLOG_WARN(...)                                                         \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_WARN, __VA_ARGS__)
...
#define SLOG_ERROR(...)                                                        \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_ERROR, __VA_ARGS__)
...
#define SLOG_BZ_INFO(...)                                                      \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_BZ_INFO, __VA_ARGS__)
...
#define SLOG_BZ_WARN(...)                                                      \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_BZ_WARN, __VA_ARGS__)
...
#define SLOG_BZ_ERROR(...)                                                     \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_BZ_ERROR, __VA_ARGS__)
...
#define SLOG_FATAL(...)                                                        \
  _SLog_LogImpl(__FILE__, sizeof(__FILE__), __LINE__, __FUNCTION__,            \
                _SLOG_MASK, SLOG_LEVEL_FATAL, __VA_ARGS__)
...
#define SLOG_ASSERT2(EXPR, ...)                                                \
  do {                                                                         \
    if (__spk_unlikely(!(EXPR))) {                                             \
      SLOG_ERROR("[ERROR] ASSERT: (" __STRING(EXPR) ") - " __VA_ARGS__);       \
      assert((EXPR));                                                          \
    }                                                                          \
  } while (0)
#else /* _VA_MACRO_ABLE */
...
#define SLOG_ASSERT_NA2(EXPR, ...)                                             \
  do {                                                                         \
    if (__spk_unlikely(!(EXPR))) {                                             \
      SLOG_ERROR("[ERROR] ASSERT_NA: (" __STRING(EXPR) ") - " __VA_ARGS__);    \
    }                                                                          \
  } while (0)
#else /* _VA_MACRO_ABLE */
