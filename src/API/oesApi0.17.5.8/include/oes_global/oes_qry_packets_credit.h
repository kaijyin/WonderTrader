 ...
 *              - 新增结构体
 * 查询融资融券合约信息过滤条件(OesQryCrdDebtContractFilterT)
 ...
 *              - 新增结构体
 * 查询融资融券合约流水信息过滤条件(OesQryCrdDebtJournalFilterT)
 *              - 新增结构体 融资融券合约流水信息内容(OesCrdDebtJournalItemT)
 *              - 新增结构体
 * 查询融资融券合约流水信息请求(OesQryCrdDebtJournalReqT)
 *              - 新增结构体
 * 查询融资融券合约流水信息应答(OesQryCrdDebtJournalRspT)
 *          - 新增 '客户单证券融资融券负债统计信息查询' 相关报文定义
 *              - 新增结构体
 * 查询客户单证券融资融券负债统计信息过滤条件(OesQryCrdSecurityDebtStatsFilterT)
 *              - 新增结构体
 * 客户单证券融资融券负债统计信息内容(OesCrdSecurityDebtStatsItemT)
 *              - 新增结构体
 * 查询客户单证券融资融券负债统计信息请求(OesQryCrdSecurityDebtStatsReqT)
 *              - 新增结构体
 * 查询客户单证券融资融券负债统计信息应答(OesQryCrdSecurityDebtStatsRspT)
 *          - 新增 '信用资产信息查询' 相关报文定义
 *              - 新增结构体
 * 查询信用资产信息过滤条件(OesQryCrdCreditAssetFilterT)
 ...
 *              - 新增结构体
 * 查询资金头寸信息过滤条件(OesQryCrdCashPositionFilterT)
 ...
 *              - 新增结构体
 * 查询证券头寸信息过滤条件(OesQryCrdSecurityPositionFilterT)
 ...
 *              - 新增结构体
 * 融资融券息费利率过滤条件(OesQryCrdInterestRateFilterT)
 ...
 * (OesQryCrdSecurityDebtStatsFilterT) 中:
 *              - 新增查询条件 是否有融资融券负债标识(hasCreditDebtFlag)
 *          - 查询融资融券可充抵保证金证券及融资融券标的信息过滤条件过滤条件
 * (OesQryCrdUnderlyingInfoFilterT) 中:
 *              - 删除查询条件 证券账户代码(invAcctId)
 *          - 查询融资融券可充抵保证金证券及融资融券标的信息应答内容
 * (OesCrdUnderlyingInfoItemT) 中:
 ...
 *              - 新增结构体
 * 融资融券业务可取资金信息(OesCrdDrawableBalanceItemT)
 *              - 新增结构体
 * 查询融资融券业务可取资金信息请求(OesQryCrdDrawableBalanceReqT)
 *              - 新增结构体
 * 查询融资融券业务可取资金信息应答(OesQryCrdDrawableBalanceRspT)
 *          - 新增 '查询融资融券担保品可转出的最大数量信息' 相关报文定义
 *              - 新增结构体
 * 融资融券担保品可转出的最大数量信息(OesCrdCollateralTransferOutMaxQtyItemT)
 *              - 新增结构体
 * 查询担保品可转出的最大数量信息请求(OesQryCrdCollateralTransferOutMaxQtyReqT)
 *              - 新增结构体
 * 查询担保品可转出的最大数量信息应答(OesQryCrdCollateralTransferOutMaxQtyRspT)
 *
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CREDIT_ASSET_FILTER {0}, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_CREDIT_ASSET_ITEM NULLOBJ_OES_CRD_CREDIT_ASSET_BASE_INFO
/* -------------------------           */
...
typedef struct _OesQryCrdCreditAssetReq {
  ...
  /** 查询过滤条件 */
  OesQryCrdCreditAssetFilterT qryFilter;
} OesQryCrdCreditAssetReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CREDIT_ASSET_REQ                                   \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_CREDIT_ASSET_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdCreditAssetRsp {
  ...
  /** 信用资产信息数组 */
  OesCrdCreditAssetItemT qryItems[OES_MAX_CRD_CREDIT_ASSET_ITEM_CNT_PER_PACK];
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_UNDERLYING_INFO_FILTER {0}, {0}, 0, 0, 0, {0}, 0
/* -------------------------           */
...
typedef struct _OesQryCrdUnderlyingInfoReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdUnderlyingInfoFilterT qryFilter;
} OesQryCrdUnderlyingInfoReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_UNDERLYING_INFO_REQ                                \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_UNDERLYING_INFO_FILTER }
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CASH_POSITION_FILTER {0}, {0}, 0, {0}, 0
/* -------------------------           */
...
#define NULLOBJ_OES_CRD_CASH_POSITION_ITEM                                     \
  __NULLOBJ_OES_CRD_CASH_POSITION_BASE_INFO_PKT, 0, {0}, {0}
/* -------------------------           */
...
typedef struct _OesQryCrdCashPositionReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdCashPositionFilterT qryFilter;
} OesQryCrdCashPositionReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CASH_POSITION_REQ                                  \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_CASH_POSITION_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdCashPositionRsp {
  ...
  OesQryRspHeadT rspHead;
  /** 融资融券业务资金头寸信息数组 */
  OesCrdCashPositionItemT qryItems[OES_MAX_CRD_CASH_POSITION_ITEM_CNT_PER_PACK];
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_SECURITY_POSITION_FILTER {0}, {0}, {0}, 0, 0, {0}, 0
/* -------------------------           */
...
#define NULLOBJ_OES_CRD_SECURITY_POSITION_ITEM                                 \
  __NULLOBJ_OES_CRD_SECURITY_POSITION_BASE_INFO_PKT, 0, {0}, {0}
/* -------------------------           */
...
typedef struct _OesQryCrdSecurityPositionReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdSecurityPositionFilterT qryFilter;
} OesQryCrdSecurityPositionReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_SECURITY_POSITION_REQ                              \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_SECURITY_POSITION_FILTER }
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_DEBT_CONTRACT_ITEM NULLOBJ_OES_CRD_DEBT_CONTRACT_REPORT
/* -------------------------           */
...
typedef struct _OesQryCrdDebtContractReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdDebtContractFilterT qryFilter;
} OesQryCrdDebtContractReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_DEBT_CONTRACT_REQ                                  \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_DEBT_CONTRACT_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdDebtContractRsp {
  ...
  OesQryRspHeadT rspHead;
  /** 融资融券合约信息数组 */
  OesCrdDebtContractItemT qryItems[OES_MAX_CRD_DEBT_CONTRACT_ITEM_CNT_PER_PACK];
...
typedef struct _OesQryCrdDebtJournalFilter {
  ...
  /** 查询融资融券合约流水的起始日期 (目前仅支持查询当日流水, 格式为 YYYYMMDD,
   * 形如 20160830) */
  int32 startDate;
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_DEBT_JOURNAL_ITEM NULLOBJ_OES_CRD_DEBT_JOURNAL_BASE_INFO
/* -------------------------           */
...
typedef struct _OesQryCrdDebtJournalReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdDebtJournalFilterT qryFilter;
} OesQryCrdDebtJournalReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_DEBT_JOURNAL_REQ                                   \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_DEBT_JOURNAL_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdDebtJournalRsp {
  ...
  OesQryRspHeadT rspHead;
  /** 融资融券合约流水信息数组 */
  OesCrdDebtJournalItemT qryItems[OES_MAX_CRD_DEBT_JOURNAL_ITEM_CNT_PER_PACK];
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CASH_REPAY_FILTER {0}, {0}, 0, 0, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_CASH_REPAY_ITEM NULLOBJ_OES_CRD_CASH_REPAY_REPORT
/* -------------------------           */
...
typedef struct _OesQryCrdCashRepayReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdCashRepayFilterT qryFilter;
} OesQryCrdCashRepayReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_CASH_REPAY_REQ                                     \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_CASH_REPAY_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdCashRepayRsp {
  ...
  OesQryRspHeadT rspHead;
  /** 融资融券业务直接还款信息数组 */
  OesCrdCashRepayItemT qryItems[OES_MAX_CRD_CASH_REPAY_ITEM_CNT_PER_PACK];
...
typedef struct _OesQryCrdSecurityDebtStatsFilter {
  ...
  uint8 mktId;
  /** 是否有融资融券负债标识 (0:未指定, 1:有融资负债(含其他负债), 2:有融券负债,
   * 3:有融资或融券负债) */
...
typedef struct _OesQryCrdSecurityDebtStatsReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdSecurityDebtStatsFilterT qryFilter;
} OesQryCrdSecurityDebtStatsReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_SECURITY_DEBT_STATS_REQ                            \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_SECURITY_DEBT_STATS_FILTER }
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_EXCESS_STOCK_FILTER {0}, {0}, {0}, 0, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_EXCESS_STOCK_ITEM NULLOBJ_OES_CRD_EXCESS_STOCK_BASE_INFO
/* -------------------------           */
...
typedef struct _OesQryCrdExcessStockReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdExcessStockFilterT qryFilter;
} OesQryCrdExcessStockReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_EXCESS_STOCK_REQ                                   \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_EXCESS_STOCK_FILTER }
/* -------------------------           */
...
typedef struct _OesQryCrdExcessStockRsp {
  ...
  OesQryRspHeadT rspHead;
  /** 融资融券业务余券信息数组 */
  OesCrdExcessStockItemT qryItems[OES_MAX_CRD_EXCESS_STOCK_ITEM_CNT_PER_PACK];
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_INTEREST_RATE_FILTER {0}, 0, 0, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_INTEREST_RATE_ITEM NULLOBJ_OES_COMMISSION_RATE_ITEM
/* -------------------------           */
...
typedef struct _OesQryCrdInterestRateReq {
  ...
  OesQryReqHeadT reqHead;
  /** 查询过滤条件 */
  OesQryCrdInterestRateFilterT qryFilter;
} OesQryCrdInterestRateReqT;

/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_INTEREST_RATE_REQ                                  \
  {NULLOBJ_OES_QRY_REQ_HEAD}, { NULLOBJ_OES_QRY_CRD_INTEREST_RATE_FILTER }
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_DRAWABLE_BALANCE_ITEM {0}, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_DRAWABLE_BALANCE_REQ {0}, {0}
/* -------------------------           */
...
typedef struct _OesQryCrdDrawableBalanceRsp {
  /** 融资融券业务最大可取资金信息 */
  OesCrdDrawableBalanceItemT drawableBalanceItem;
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_CRD_TRANSFER_OUT_MAX_QTY_ITEM {0}, {0}, 0, {0}, 0
/* -------------------------           */
...
/* 结构体的初始化值定义 */
#define NULLOBJ_OES_QRY_CRD_TRANSFER_OUT_MAX_QTY_REQ {0}, {0}, 0, {0}
/* -------------------------           */
...
typedef struct _OesQryCrdCollateralTransferOutMaxQtyRsp {
  /** 融资融券担保品可转出的最大数量信息 */
  OesCrdCollateralTransferOutMaxQtyItemT collateralTransferOutMaxQtyItem;
