...
// 定义推送回调函数
typedef void (*pMessageCallbackMethod)(const char *pTime, const char *pMsg,
                                       int nType);
// 定义异步回调函数
typedef void (*pAsyncCallbackFunc)(const char *pTime, const char *pMsg,
                                   int nType);
// 定义掉线、重连回调函数
typedef void (*pConnEventCallback)(const char *pKhh, const char *pConnKey,
                                   int nEvent, void *pData);
