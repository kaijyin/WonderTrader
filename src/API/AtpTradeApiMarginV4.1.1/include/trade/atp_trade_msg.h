// code_generator_tag
// messages:e733758a9d8f0a6ec25d135dd2ad80c6
// template:d5e676b48a16d8942e0c6cea656a6229
// code:3ae66a742a45c34004c439036ee62344
...
struct TRADE_API ATPConnectProperty {
  ...
  int32_t
      heartbeat_interval_milli; ///< 发送心跳的时间间隔,单位：毫秒，默认值：5000
  int32_t connect_timeout_milli; ///< 连接超时时间，单位：毫秒，默认值：5000
  int32_t reconnect_time;        ///< 重试连接次数，默认值：连接地址数
  std::map<int32_t, int32_t>
      report_sync;            ///< 回报同步数据map<int32_t, int32_t>，默认值：空
  std::string client_name;    ///< 客户端名称
  std::string client_version; ///< 客户端版本号
  int32_t
      mode; ///< 模式mode为1时快速登录，不处理回报同步，API与AGW的tcp连接断开情况下存在委托丢失.默认0进行回报同步处理
...
struct TRADE_API ATPReqCashAuctionOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPSecurityIDType security_id; /// 证券代码
  ATPMarketIDType market_id;     /// 市场代码
  ATPSideType side;              /// 买卖方向
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPPriceType price; /// 委托价格N13(4)
                      /// （主板市价委托填0，科创板股票市价委托必须输入保护价）
  ...
  ATPBatchClOrdNoType batch_cl_ord_no; /// 客户自定义委托批号（0为系统保留值，不允许使用）（ATP
                                       /// V3.2.3版本开始支持）
...
struct TRADE_API APIBatchCashAuctionOrderUnit {
  ...
  ATPSideType side;              /// 买卖方向
  ATPQtyType
      order_qty; /// 申报数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPPriceType price; /// 委托价格N13(4)
                      /// （主板市价委托填0，科创板股票市价委托必须输入保护价）
  ATPOrdTypeType order_type; /// 订单类型
...
struct TRADE_API ATPReqMarginNoTradeOrderMsg {
  ...
  ATPPasswordType password; /// 客户密码（该字段是否必填请咨询券商）
  ATPExtraData
      extra_data; /// 扩展字段（指定合约偿还列表，ATP3.1.11开始支持；具体填写规则可参考引言中的接口约定）
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPSecurityIDType security_id; /// 证券代码
  ATPMarketIDType market_id;     /// 市场代码
  ATPSideType side; /// 买卖方向（投资者：'L'= 担保品返还、'T'= 直接还券、'V'=
                    /// 担保品提交）
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
  ATPPbuIDType dest_pbu_id; /// 对方申报交易单元 （买卖方向 =
                            /// ‘L’、‘V’时：深市必传，沪市传空）
  ATPAccountIDType dest_account_id; /// 对方证券账户 （买卖方向 =
                                    /// ‘L’、‘V’时：深市必传，沪市传空）
  ATPRedeliverType
      redeliver_type; /// 直接还券类型（默认值为255，表示不指定）,ATP3.1.10.1开始支持非必填
  ATPImmediateEffectType
      immediate_effect; /// 实时划转标志,0:非实时划转,1:实时划转
...
struct TRADE_API ATPReqOptionQuoteOrderMsg {
  ...
  ATPMarketIDType market_id;     /// 市场代码
  ATPQtyType
      bid_order_qty; /// 买申报数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ...
  ATPQtyType offer_order_qty; /// 卖数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
                              /// 填0时，即可进行卖委托的撤单
...
struct TRADE_API APINoLegsOrderUnit {
  ...
  ATPCoveredOrUncoveredType leg_covered_or_uncovered; /// 腿备兑标签
  ATPQtyType
      leg_order_qty; /// 成份合约数量
                     /// 此字段响应时返回；委托不需要填（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API ATPReqOptionCombinationOrderMsg {
  ...
  ATPSecondaryOrderIDType
      secondary_order_id; /// 组合编码，买卖方向为解除时需要填，组合时不需要填
  ATPAccountSubCodeType account_sub_code; /// 账户子编码（已弃用）
...
struct TRADE_API ATPReqSwapPutbackOrderMsg {
  ...
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPPriceType price; /// 委托价格N13(4) （沪深已弃用，北交所有效且必填）
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
  ATPShareNegotiabilityType
      share_negotiability; /// 股份性质，定向可转债转股申报必填
...
struct TRADE_API ATPReqDesignationOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPSecurityIDType
      security_id; /// 证券代码（默认值为空字符串，表示该证券账户下的全部证券）
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
...
struct TRADE_API ATPReqDesignatedTransactionOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPSecurityIDType
      security_id; /// 证券代码 "799998"=撤销指定交易  "799999"=登记指定交易
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
...
struct TRADE_API ATPReqNetVotingOrderMsg {
  ...
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// 累积投票议案时，OrderQty字段填写投票数量，其他情况填0
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
  ATPGeneralMeetingSeqType general_meeting_seq; /// 股东大会编码
  ATPVotingProposalType
      voting_proposal; /// 投票议案编号及子议案编号（沪深通用），议案和子议案用小数点分隔。例如：2.01，表示议案编号2，子议案编号1
...
struct TRADE_API ATPReqPasswordServiceOrderMsg {
  ...
  ATPSecurityIDType security_id; /// 证券代码
  ATPMarketIDType market_id;     /// 市场代码
  ATPSideType side; /// 买卖方向 。 'A'= Activation 密码激活 ，'C'= Cancellation
                    /// 密码注销
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
...
struct TRADE_API ATPReqCancelOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPMarketIDType market_id; /// 市场代码，开通北交所业务后必填
  ATPClOrdNOType
      orig_cl_ord_no; /// 原始交易客户方（券商）订单编号，指示被撤消订单的cl_ord_no
  ATPBatchClOrdNoType batch_cl_ord_no; /// 客户自定义委托批号，与orig_cl_ord_no至少填写一项。若orig_cl_ord_no不为空，则按orig_cl_ord_no撤单；否则，batch_cl_ord_no不为空，按batch_cl_ord_no撤单(ATP
                                       /// V3.2.3版本开始支持)
...
struct TRADE_API ATPReqBatchCancelOrderMsg {
  ATPCustIDType
      cust_id; /// 客户号ID，如果证券账号为空，则按客户号进行撤单，如果证券账户和客户号均为空则指令无效
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPAccountIDType
      account_id; /// 证券账户ID
                  /// ，填空则按照客户号一键撤单，填写了证券账户，则优先按证券账户进行撤单
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPOrderWayType order_way; /// 委托方式（是否必填以及字典项请咨询券商）
  ATPUserInfoType user_info; /// 用户私有信息
  ATPPasswordType password; /// 客户密码（该字段是否必填请咨询券商）
...
struct TRADE_API ATPReqFDEPCancelOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPMarketIDType market_id; /// 市场ID，固定102
  ATPClOrdNOType
      orig_cl_ord_no; /// 原始交易客户方（券商）订单编号，指示被撤消订单的cl_ord_no
...
struct TRADE_API ATPRspOrderStatusAckMsg {
  ...
  ATPOrdStatusType ord_status; /// 当前申报的状态,（对于撤单委托，填写被撤委托的当前状态，找不到原始委托时，固定填8=
                               /// Reject ）
  ATPCustIDType cust_id;                /// 客户号ID
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPAccountIDType account_id;          /// 证券账户ID
  ATPPriceType
      price; /// 委托价格N13(4)（上交所市价转限价申报时，这里填写转为限价订单的价格，其他订单填0）
  ATPQtyType
      order_qty; /// 委托数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      leaves_qty; /// 未成交部分的数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      cum_qty; /// 累计成交数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPSideType side; /// 买卖方向
  ATPTimeStampType
      transact_time; /// 回报时间（如果是ATP的Ack则回报时间为ATP的，如果是交易所的确认则回报时间为交易所的。同理，成交回报都是交易所的回报时间）
  ATPUserInfoType user_info; /// 用户私有信息
  ATPOrderIDType order_id;   /// 交易所订单编号
  ATPClOrdIDType
      cl_ord_id; /// 申报合同号
                 /// 上交所：以QP1开头，表示为交易所保证金强制平仓；以CV1开头，表示为交易所备兑强制平仓；
  ATPExtraData extra_data;          /// 扩展字段
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPClOrdNOType orig_cl_ord_no; /// 对于撤单返回的状态响应，为原始委托的客户合同号，指示被撤消订单的cl_ord_no;
                                 /// 对于委托确认，取值为0
  ATPAmtType frozen_trade_value; /// 冻结交易金额N18(4)
  ATPAmtType frozen_fee;         /// 冻结费用N18(4)
  ATPRejectReasonCodeType
      reject_reason_code; /// 拒绝原因代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-5
                          /// 拒绝原因错误码类型，即可查询到错误描述信息
  ATPOrdRejReasonType
      ord_rej_reason; /// 拒绝原因描述信息；当交易所拒绝时，这里填写交易所返回的拒绝原因代码。可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-1交易所拒绝原因错误码类型，即可查询错误描述信息
  ATPOrdTypeType order_type;        /// 订单类型
  ...
  ATPParticularFlagsType
      particular_flags; /// 特殊委托标识，右起第一个bit位是夜市委托标志位：0-正常委托、1-夜市委托（ATP3.2.0开始支持）
  ATPBatchClOrdNoType batch_cl_ord_no; /// 客户自定义委托批号，对于撤单返回响应，为原订单的客户自定义委托批号(ATP
                                       /// V3.2.3版本开始支持)
...
struct TRADE_API ATPRspBatchOrderStatusAckMsg {
  ...
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPClOrdNOType
      orig_parent_cl_ord_no; /// 原始委托的客户合同号，指示被撤消批量订单的cl_ord_no;
  ATPRejectReasonCodeType
      reject_reason_code; /// 拒绝原因代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-5
                          /// 拒绝原因错误码类型，即可查询到错误描述信息
  ATPOrdRejReasonType
...
struct TRADE_API ATPRspQuoteStatusAckMsg {
  ...
  ATPOrdStatusType bid_ord_status; /// 买订单当前申报的状态
                                   /// 当不存在买委托时，返回99表示无意义状态
  ATPExecTypeType offer_exec_type;   /// 卖订单当前执行类型
  ATPOrdStatusType offer_ord_status; /// 卖订单当前申报的状态
                                     /// 当不存在卖委托时，返回99表示无意义状态
  ATPCustIDType cust_id;                /// 客户号ID
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPAccountIDType account_id;          /// 证券账户ID
  ATPPriceType bid_price;               /// 买委托价格N13(4)
  ATPQtyType
      bid_order_qty; /// 买委托数量，当为报价撤单时为0（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      bid_leaves_qty; /// 买未成交部分的数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      bid_cum_qty; /// 买累计成交数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPPriceType offer_price; /// 卖委托价格N13(4)
  ATPQtyType
      offer_order_qty; /// 卖委托数量，当为报价撤单时为0（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      offer_leaves_qty; /// 卖未成交部分的数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      offer_cum_qty; /// 卖累计成交数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPTimeStampType
      transact_time; /// 回报时间（如果是TE的Ack则回报时间为TE的，如果是交易所的确认则回报时间为交易所的。同理，成交回报都是交易所的回报时间）
  ATPUserInfoType user_info;           /// 用户私有信息
  ATPExtraData extra_data;             /// 扩展字段
  ATPClientSeqIDType client_seq_id;    /// 用户系统消息序号
  ...
  ATPOrdRejReasonType
      ord_rej_reason; /// 拒绝原因描述信息；当交易所拒绝时，这里填写交易所返回的拒绝原因代码。可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-1交易所拒绝原因错误码类型，即可查询错误描述信息
  ATPPositionEffectType
      bid_position_effect; /// 买委托开仓/平仓,'C'=平仓,'O'=开仓 报价撤单时为空
  ATPPositionEffectType offer_position_effect; /// 卖委托开仓/平仓,'C'=平仓,'O'=开仓
                                               /// 报价撤单时为空
  ATPAccountSubCodeType account_sub_code; /// 账户子编码（无意义）
...
struct TRADE_API ATPRspCashAuctionTradeERMsg {
  ...
  ATPQtyType
      last_qty; /// 成交数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ...
  ATPParticularFlagsType
      particular_flags; /// 特殊委托标识，右起第一个bit位是夜市委托标志位：0-正常委托、1-夜市委托（ATP3.2.0开始支持）
  ATPBatchClOrdNoType
      batch_cl_ord_no; /// 客户自定义委托批号(ATP V3.2.3版本开始支持)
  ATPAmtType net_total_value_traded; /// 成交金额（含利息）N18(4)(ATP
                                     /// V3.2.3.2版本开始支持)
...
struct TRADE_API ATPRspCreditTradeERMsg {
  ...
  ATPQtyType
      order_qty; /// 委托数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      leaves_qty; /// 未成交部分的数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）（注意，上交所回报该字段含义：对应申报是市价转撤单的时候，这里填写自动撤单的数量；对应申报是市价转限价的时候，这里填写转为限价订单的数量；当对应申报是限价订单时，填写撤单成功的数量；缺省填0；深交所回报该字段含义：订单未成交部分的数量）
  ATPQtyType
      cum_qty; /// 累计成交数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPSideType side;               /// 买卖方向
  ATPTimeStampType transact_time; /// 回报时间
...
struct TRADE_API APIConstituentStockUnit {
  ATPSecurityIDType
      security_id; /// 成分股证券代码，例外：1-沪市资金代码、2-深市或京市资金代码、3-港市资金代码、9-非沪港深京资金代码（全额现金申赎）
  ATPMarketIDType market_id; /// 市场代码，当security_id为资金代码时为空
  ATPQtyType
      qty; /// 成交数量，当security_id为资金代码时为0（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPAmtType
      amt; /// 成交金额N18(4)，对于沪市ETF申赎成交回报，security_id为资金代码时有值，否则为0；对于深市ETF，原逻辑不变。
...
struct TRADE_API ATPRspETFRedemptionTradeERMsg {
  ...
  ATPQtyType
      order_qty; /// 委托数量N15(2)，原申赎份额（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      leaves_qty; /// 未成交部分的数量N15(2)，一但有成交则认为全部成交，所以此处为0（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      cum_qty; /// 累计成交数量N15(2)，原申赎份额（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPSideType side;               /// 买卖方向 'D'=申购  'E'=赎回
  ATPTimeStampType transact_time; /// 回报时间
  ATPUserInfoType user_info;      /// 用户私有信息
  ATPOrderIDType order_id;        /// 交易所订单编号
...
struct TRADE_API ATPRspBondDistributionTradeERMsg {
  ...
  ATPAccountIDType account_id;          /// 证券账户ID
  ATPPriceType
      price; /// 委托价格N13(4)（上交所市价转限价申报时，这里填写转为限价订单的价格，其他订单填0）单位：元（精确到0.0001元）
  ATPQtyType
      order_qty; /// 委托数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      leaves_qty; /// 未成交部分的数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
...
struct TRADE_API ATPReqOrderQueryMsg {
  ...
  ATPClOrdNOType
      cl_ord_no; /// 客户订单编号
                 /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPMarketIDType
      market_id; /// 市场代码（默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有。开通北交所业务后必填）
  ATPSecurityIDType
      security_id; /// 证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPBusinessTypeType
      business_type; /// 业务类型
                     /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPSideType
      side; /// 买卖方向
            /// （默认值为'0'，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPOrderQueryConditionType
      order_query_condition; /// 委托查询条件
                             /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 查询返回数量
                  /// （默认值为0，表示按能返回的最大数量返回，具体数量请咨询券商）
  ATPReturnSeqType
      return_seq; /// 返回顺序，按时间排序 （默认值为1，表示按时间正序排序）
  BusinessAbstractType business_abstract_type; /// 抽象业务编码
  ATPBatchClOrdNoType
      batch_cl_ord_no; /// 客户自定义委托批号(ATP V3.2.3版本开始支持)
...
struct TRADE_API ATPReqBatchOrderQueryMsg {
  ...
  ATPOrderQueryConditionType
      order_query_condition; /// 委托查询条件
                             /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPMarketIDType
      market_id; /// 市场代码，开通北交所业务后必填（ATP V3.4版本开始支持）
...
struct TRADE_API APIQuoteUnit {
  ...
  ATPQtyType
      bid_order_qty; /// 买委托数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      bid_leaves_qty; /// 买未成交部分的数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      bid_cum_qty; /// 买累计成交数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ...
  ATPQtyType
      offer_order_qty; /// 卖委托数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      offer_leaves_qty; /// 卖未成交部分的数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      offer_cum_qty; /// 卖累计成交数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ...
  ATPClOrdIDType
      cl_ord_id; /// 申报合同号,上交所：以QP1开头,表示为交易所保证金强制平仓；以CV1开头,表示为交易所备兑强制平仓；
...
struct TRADE_API ATPRspQuoteQueryResultMsg {
  ...
  ATPAccountIDType account_id;          /// 证券账户ID
  ATPClientSeqIDType client_seq_id;     /// 用户系统消息序号
  ATPQueryResultCodeType
      query_result_code; /// 查询结果代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型
                         /// -3 查询结果错误码类型，即可查询到错误描述信息
  ATPUserInfoType user_info;     /// 用户私有信息
  ATPExtraData extra_data;       /// 扩展字段
...
struct TRADE_API APICombinationUnit {
  ...
  ATPSecurityIDType strategy_id;              /// 策略编码
  ATPQtyType
      init_combi_position; /// 日初组合持仓量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      combi_position; /// 组合实时持仓数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      frozen_combi_position; /// 组合解除冻结数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API ATPReqTradeOrderQueryMsg {
  ...
  ATPMarketIDType
      market_id; /// 市场代码
                 /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有。开通北交所业务后必填）
  ATPSecurityIDType
      security_id; /// 证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPBusinessTypeType
  ...
  ATPExecIDType exec_id;                       /// 执行编号
  ATPEtfPurchaseRedemptionFlagType
      etf_purchase_redemption_flag; /// 是否返回ETF申赎成交：0-不返回，1-返回（ATP3.2.1开始支持）
  ATPBatchClOrdNoType
      batch_cl_ord_no; /// 客户自定义委托批号(ATP V3.2.3版本开始支持)
...
struct TRADE_API ATPReqExtQueryContractSpecificationsMsg {
  ...
  ATPCloseOutFlagType
      close_out_flag; /// 了结标识
                      /// （默认值为'0'，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPCashMarginSetType cash_margin_set; /// 信用标识集合
                                        /// （默认值为空字符串，表示查所有；标志位之间请用逗号隔开，如需查询融券合约与融资利息两种合约明细请填写"2,3"
                                        /// 具体填写规则可参考引言中的接口约定）
  ATPDate8Type
      opening_date; /// 开仓日期 （默认值为0，格式为YYYYMMDD，如20210514）
  ...
  ATPReturnSeqType
      return_seq; /// 返回顺序，按时间排序 （默认值为1，表示按时间正序排序）
  ATPContractSerialNumType
      contract_serial_num; /// 合同序号（ATP4.0.0版本开始支持）
...
struct TRADE_API ATPReqExtQueryMarginUseableMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPBranchIDType branch_id; /// 营业部ID
  ATPQueryContentsType
      query_contents; /// 查询内容 '0'= 只查询余额，'1'= 查询余额及明细
  ATPMarketIDType
      market_id; /// 市场代码
                 /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）（ATP3.1.10.1开始支持）
  ATPSecurityIDType
      security_id; /// 证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）（ATP3.1.10.1开始支持）
...
struct TRADE_API ATPReqExtQueryContractSpecificationsManagerMsg {
  ...
  ATPCloseOutFlagType
      close_out_flag; /// 了结标识
                      /// （默认值为'0'，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPCashMarginSetType
      cash_margin_set; /// 信用标识集合（该接口仅支持1-融资合约,2-融券合约两种类型，标志位之间用逗号隔开;具体填写规则可参考引言中的接口约定）
  ATPDate8Type
      opening_date; /// 开仓日期 (默认值为0，格式为YYYYMMDD，如20210514）
  ATPOpeningSerialNumType opening_serial_num; /// 开仓流水号
                                              /// （默认值为空字符串）
...
struct TRADE_API ATPReqExtQueryMarginUnderlyingMsg {
  ...
  ATPSecurityIDType
      security_id; /// 证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPCRDUnderlyingTypeType
      underlying_query_type; /// 标的类型
                             /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPIsQueryMarginQtyType
      is_query_margin_qty; /// 是否输出融券专户可用数量（默认值为0，表示不输出：记录都输出且融券专户可用数量默认0）
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 查询返回数量
...
struct TRADE_API ATPReqFundQueryMsg {
  ...
  ATPAccountIDType
      account_id; /// 证券账户ID
                  /// （一户两地账户此字段必填）（ATP3.1.7版本开始支持此字段非必填）
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPUserInfoType user_info;        /// 用户私有信息
  ATPPasswordType password; /// 客户密码（该字段是否必填请咨询券商）
  ATPExtraData extra_data; /// 扩展字段
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPCurrencyType
      currency; /// 货币种类（ATP3.1.8.1开始支持非必填）（默认值为空串表示查询CNY）
  ATPMarketIDType
      market_id; /// 市场代码，开通北交所业务后必填（ATP V3.4版本开始支持）
...
struct TRADE_API ATPReqShareQueryMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  std::vector<APIAccountIDUnit>
      account_id_array; /// 待查证券账户组（ATP3.1.6版本开始支持非必填）
  ATPBusinessTypeType business_type; /// 业务类型（无意义）
  ATPMarketIDType
      market_id; /// 市场代码
                 /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有。开通北交所业务后必填）（ATP3.1.6版本开始支持此字段非必填）
  ATPSecurityIDType
      security_id; /// 证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPReportIndexType
...
struct TRADE_API ATPReqTIBIPOQtyQueryMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPMarketIDType market_id; /// 市场ID 固定101
...
struct TRADE_API ATPReqHKExtQueryMaxQueryOrderQtyMsg {
  ...
  ATPOrderWayType order_way; /// 委托方式（是否必填以及字典项请咨询券商）
  ATPEntitlementType entitlement_number;           /// 权益编码 (已弃用)
  ATPBranchIDType branch_id;                       /// 营业部ID
  ATPEntitlementNumberType entitlement_number_new; /// 权益编码
...
struct TRADE_API ATPReqCustLoginOtherMsg {
  ATPCustIDType
      cust_id; /// 客户号ID （当登录模式为1-客户号登录模式时，该字段必填）
  ATPFundAccountIDType
      fund_account_id; /// 资金账户ID
                       /// （当登录模式为2-资金账户登录模式时，该字段必填）
  ATPAccountIDType
      account_id; /// 证券账户ID
                  /// （当登录模式为3-证券账户登录模式时，该字段必填）
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPUserInfoType user_info;        /// 用户私有信息
  ATPExtraData extra_data;          /// 扩展字段
  ATPClientFeatureCodeType
  ...
  ATPBranchIDType
      branch_id; /// 营业部ID
                 /// （当登录模式为2-资金账户登录模式时，该字段是否必填请咨询券商）
...
struct TRADE_API ATPReqExtFundTransferOtherMsg {
  ...
  ATPMarketIDType
      market_id; /// 市场代码，开通北交所业务后必填（ATP V3.4版本开始支持）
  ATPFundPropertyType fund_property; /// 资金属性：'0'=T+0 '1'=T+1
                                     /// ，可指定要划拨的资金属性，当不填时以配置的全局资金划拨参数为准。（ATP
                                     /// V4.0.0版本开始支持）
 ...
 *  @brief 网关用户密码修改消息
 */
struct TRADE_API ATPReqAgwUserPasswdModifyMsg {
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPStringType agw_user;           /// 网关用户
  ATPStringType agw_user_password;  /// 网关用户原密码
  ATPCustIDType cust_id; /// 客户号（当登录模式为1-客户号登录模式时，该字段必填）
  ATPFundAccountIDType
      fund_account_id; /// 资金账户（当登录模式为2-资金账户登录模式时，该字段必填）
  ATPBranchIDType
      branch_id; /// 营业部（当登录模式为2-资金账户登录模式时，该字段是否必填请咨询券商）
  ATPPasswordType password; /// 客户密码
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPOrderWayType order_way; /// 委托方式（是否必填以及字典项请咨询券商）
  ATPLoginModeType login_mode; /// 登录模式：1-客户号登录 2-资金账户登录
  ATPAgwUserPasswdType
      agw_user_new_password; /// 网关用户新密码。密码强度要求：密码长度为8-16个字符，至少包含数字,字母和特殊符号~!@#$%^&*?的两项以上
  ATPUserInfoType user_info; /// 用户私有信息
  ATPExtraData extra_data;   /// 扩展字段

  ATPReqAgwUserPasswdModifyMsg();
};

/**
 *  @brief 网关用户密码修改应答
 */
struct TRADE_API ATPRspAgwUserPasswdModifyResultMsg {
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPStringType agw_user;           /// 网关用户
  ATPRejectReasonCodeType
      reject_reason_code; /// 拒绝原因代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-5
  ...
  ATPRspAgwUserPasswdModifyResultMsg();
};
...
struct TRADE_API ATPRspMaxOrderQueryResultMsg {
  ...
  ATPExtraData extra_data;   /// 扩展字段
  ATPQtyType
      max_order_qty; /// 最大可委托数（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      theoretical_order_qty; /// 理论可委托数（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API APIContractSpecificationsUnit {
  ...
  ATPQtyType
      opening_qty; /// 开仓数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPPriceType opening_price; /// 开仓价格N13(4)
  ATPAmtType repayment_amt;   /// 已偿还金额N18(4)
  ATPQtyType
      repayment_qty; /// 已偿还数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
...
struct TRADE_API APIShareLiabilityUnit {
  ...
  ATPAccountIDType account_id;           /// 证券账户ID
  ATPQtyType
      real_time_qty; /// 实时数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPAmtType market_value; /// 市值N18(4)
  ATPQtyType
      init_qty; /// 期初数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
...
struct TRADE_API APIContractSpecificationsManagerUnit {
  ...
  ATPAmtType total_interest_liability; /// 利息负债N18(4)（融资融券利息负债）
  ATPAmtType repayment_interest; /// 已偿还利息N18(4)（融资融券已偿还利息金额）
  ATPAmtType margin_required; /// 保证金占用N18(4)
  ATPQtyType
      total_liability_qty; /// 总负债数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPAmtType total_liability_amt; /// 总负债金额N18(4)
  ATPFirstUsePrivateAmountType first_use_private_amount; /// 是否先用保底额度
  ATPContractSerialNumType
      contract_serial_num; /// 合同序号（ATP4.0.0版本开始支持）
  ATPQtyType repayment_rights_qty; /// 已偿还权益数量N15(2)
  ATPAmtType repayment_rights_amt; /// 已偿还权益金额N18(4)
  ATPAmtType rr_other_debt; /// 其他息费负债N18(4)（融资融券逾期罚息负债）
  ATPAmtType
      repayment_other_debt; /// 已偿还其他息费N18(4)（融资融券逾期罚息已偿还金额）
...
struct TRADE_API APIMarginUnderlyingUnit {
  ...
  ATPSecurityIDType security_id; /// 证券代码
  UnderlyingTypeType
      underlying_type; /// 标的类型（多个权限之间逗号分隔：1-担保品；2-融券；3-融资）
  ATPCRDUnderlyingRateType translation_proportion; /// 折算率N13(4)
  ATPCRDBusinessSwitchType
      business_switch; /// 业务开关（多个开关之间逗号分隔：1-暂停提交；2-允许展期；3-集中度控制；4-高流通性证券）
  ATPDepositRatioType
      financing_guarantee_ratio; /// 融资保证金比率N3(4)（例：508表示50.8%）
  ATPDepositRatioType
      security_guarantee_ratio; /// 融券保证金比率N3(4)（例：508表示50.8%）
...
struct TRADE_API ATPRspQueryFundAssetsInfoResultMsg {
  ...
  ATPAmtType rz_principal_debt; /// 融资本金负债N18(4)
  ATPAmtType rz_interest_debt;  /// 融资利息负债N18(4)
  ATPAmtType rq_interest_debt;  /// 融券息费负债（融券费用）N18(4)
  ATPAmtType
      rr_other_debt; /// 其他负债（除融资利息、融券费用、股份权益补偿外的其他利息负债）N18(4)
...
struct TRADE_API APIOrderUnit {
  ...
  ATPSideType side;                      /// 买卖方向
  ATPOrdTypeType ord_type;               /// 订单类别
  ATPOrdStatusType ord_status; /// 当前申报的状态，（对于撤单订单，填写被撤订单的当前状态，找不到原始订单时，固定填8
                               /// = Reject ）
  ...
  ATPClOrdNOType orig_cl_ord_no; /// 对于撤单订单，为原始交易客户方（券商）订单编号，指示被撤消订单的cl_ord_no;
                                 /// 对于普通订单，取值为0
  ATPAmtType frozen_trade_value; /// 冻结交易金额N18(4)
  ATPAmtType frozen_fee;         /// 冻结费用N18(4)
  ATPCurrencyType currency;      /// 货币种类
  ...
  ATPOrderFlagType order_flag; /// 订单标识（ATP3.1.9
                               /// 开始支持）（返回默认值表示当前版本不支持）
  ATPParticularFlagsType
      particular_flags; /// 特殊委托标识，右起第一个bit位是夜市委托标志位：0-正常委托、1-夜市委托（ATP3.2.0开始支持）
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（ATP3.2.3 开始支持）
  ATPBatchClOrdNoType batch_cl_ord_no; /// 客户自定义委托批号（对于撤单订单，为原订单的客户自定义委托批号）(ATP
                                       /// V3.2.3版本开始支持)
...
struct TRADE_API ATPRspOrderQueryResultMsg {
  ...
  ATPTotalNumType total_num;     /// 订单记录总数
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（ATP3.1.9 开始支持）
...
struct TRADE_API ATPRspBatchOrderQueryResultMsg {
  ...
  ATPClOrdNOType parent_cl_ord_no; /// 客户订单编号
  ATPOrdStatusType ord_status;     /// 当前申报的状态
  ATPReportIndexType last_index; /// 最后一笔查询结果的索引号，当 “LastIndex +1
                                 /// == TotalNum”时，表示已经查到最后的记录
  ATPTotalNumType total_num;             /// 订单记录总数
  std::vector<APIOrderUnit> order_array; /// 查询结果组合
...
struct TRADE_API APITradeOrderUnit {
  ATPBusinessTypeType business_type; /// 业务类型
  ATPSecurityIDType
      security_id; /// 证券代码（对于ETF实时申赎成交，上海市场：1-沪市资金代码、2-深市或京市资金代码、3-港市资金代码、9-非沪港深京资金代码）
  ATPSecuritySymbolType security_symbol; /// 证券简称
  ATPMarketIDType market_id;             /// 市场代码
  ATPAccountIDType account_id;           /// 证券账户ID
  ATPSideType side; /// 买卖方向（对于ETF实时申赎成交，此字段为'D'=申购 'E'=赎回
                    /// 'P'=实物申购 'R'=实物赎回）
  ATPOrdTypeType
      ord_type; /// 取原订单的订单类型（对于撤单订单，取被撤订单的订单类型）
  ATPExecTypeType
      exec_type; /// 当前订单执行类型（若为交易所确认撤单的委托，exec_type=4-Cancelled表示已撤销）
  ATPExecIDType exec_id; /// 执行编号（对于交易所确认撤单的委托，exec_id为空）
  ATPClOrdNOType
      cl_ord_no; /// 客户订单编号（若为撤单成功，为原订单编号；若为撤单失败，为撤单订单编号）
  ATPOrderIDType
      order_id; /// 交易所订单编号（对于交易所确认撤单的委托，order_id为空）
  ATPClOrdIDType
      cl_ord_id; /// 申报合同号（上交所：以QP1开头,表示为交易所保证金强制平仓；以CV1开头,表示为交易所备兑强制平仓）
  ATPTimeStampType
      transact_time; /// 成交时间（对于交易所确认撤单的委托，取交易所确认撤单的回报时间）
  ATPPriceType
      last_px; /// 成交数量N13(4)（对于交易所确认撤单的委托，取0；对于ETF实时申赎成交，取0）
  ATPQtyType
      last_qty; /// 成交数量N15(2)（对于交易所确认撤单的委托，取每笔撤单的数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）；对于ETF实时申赎成交，上海市场当security_id为资金代码时取0）
  ATPAmtType
      total_value_traded; /// 成交金额N18(4)（对于交易所确认撤单的委托，取0；对于ETF实时申赎成交，上海市场当security_id不为资金代码时取0，深圳市场取现金代替金额）
  ATPAmtType
      fee; /// 成交费用N18(4)（对于交易所确认撤单的委托，取0；对于ETF实时申赎成交，取0）
  ATPCurrencyType currency;          /// 货币种类
  ATPClientSeqIDType client_seq_id;  /// 用户系统消息序号
  ATPSecurityTypeType security_type; /// 证券类别（ATP3.1.8 开始支持）
  ATPQtyType
      order_qty; /// 委托数量N15(2)（ATP3.1.10开始支持；对于ETF实时申赎成交，同last_qty）
  ATPParticularFlagsType
      particular_flags; /// 特殊委托标识，右起第一个bit位是夜市委托标志位：0-正常委托、1-夜市委托（ATP3.2.0开始支持）
  ATPBatchClOrdNoType batch_cl_ord_no; /// 客户自定义委托批号（对于撤单成交，为原订单的客户自定义委托批号）(ATP
                                       /// V3.2.3版本开始支持)
  ATPAmtType net_total_value_traded; /// 成交金额（含利息）N18(4)（对于交易所确认撤单的委托，取0）（ATP3.2.3.2
                                     /// 开始支持）
  ATPBoolType cancel_flag; /// 撤单标识：0-非撤单，1-撤单（ATP3.5
                           /// 开始支持，3.5之前固定为0，勿用）
  ATPRejectReasonCodeType
      reject_reason_code; /// 拒绝原因代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-5
                          /// 拒绝原因错误码类型，即可查询到错误描述信息（ATP3.5
                          /// 开始支持，3.5之前固定为0，勿用）
  ATPOrdRejReasonType ord_rej_reason; /// 拒绝原因描述信息；当交易所拒绝时，这里填写交易所返回的拒绝原因代码。可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-1交易所拒绝原因错误码类型，即可查询错误描述信息（ATP3.5
                                      /// 开始支持，3.5之前固定为空，勿用）
...
struct TRADE_API APIShareRecordETFArray {
  ATPSecurityIDType
      security_id; /// 证券代码，例外：1-沪市资金代码、2-深市或京市资金代码、3-港市资金代码、9-非沪港深京资金代码（全额现金申赎）
  ATPMarketIDType market_id; /// 市场代码，当security_id为沪市资金代码时为空
  ATPQtyType
      qty; /// 成交数量或资金比例因子N15(2)，当security_id为沪市资金代码时为0
  ATPAmtType
      amt; /// 成交金额N18(4)，对于沪市ETF申赎成交回报，security_id为资金代码时有值，否则为空；对于深市ETF，原逻辑不变。
...
struct TRADE_API APIETFTradeOrderUnit {
  ...
  ATPOrdTypeType
      ord_type; /// 取原订单的订单类型，对于撤单订单，取被撤订单的订单类型
  ATPExecTypeType
      exec_type; /// 当前订单执行类型,若为交易所确认撤单的exec_type=4-Cancelled表示已撤销
  ATPExecIDType exec_id; /// 执行编号 ,对于交易所确认撤单的委托执行编号为空
  ATPClOrdNOType
      cl_ord_no; /// 客户订单编号,原订单的客户订单编号，若此笔记录为撤单，则应该是撤单的原订单
  ATPOrderIDType
      order_id; /// 交易所订单编号,交易所订单编号，对于交易所确认撤单的记录，order_id为空
  ATPClOrdIDType
      cl_ord_id; /// 申报合同号,上交所：以QP1开头,表示为交易所保证金强制平仓；以CV1开头,表示为交易所备兑强制平仓；
  ATPTimeStampType
      transact_time; /// 成交时间，对于交易所确认撤单，取交易所确认撤单的回报时间
  ATPPriceType last_px; /// 成交价格，对于交易所确认撤单，取0N13(4)
  ATPQtyType
      last_qty; /// 成交数量
                /// ,对于交易所确认撤单，取每笔撤单的数量（股票为股、基金为份、上海债券为手，其他为张）N15(2)
  ATPAmtType
      total_value_traded; /// 成交金额，N18(4)对于交易所确认撤单的委托，取0
...
struct TRADE_API ATPRspFundQueryResultMsg {
  ...
  ATPAmtType init_leaves_value; /// 日初资金金额N18(4)
  ATPAmtType
      available_t0; /// T+0可用资金N18(4)，对于两融类业务：包含昨日清算后融券冻结资金，不包含当日融券卖出冻结资金
  ATPAmtType
      available_t1; /// T+1可用资金N18(4)，对于两融类业务：包含融券卖出冻结资金（买高流通股票、买券还券时可全额使用，买非高流通股份、直接还款时可用资金为：T+1可用资金（available_t1）减去融券卖出冻结金额（credit_sell_frozen））
  ATPAmtType available_t2;          /// T+2可用资金N18(4)
  ATPAmtType available_t3;          /// T+3可用资金N18(4)
  ATPAmtType available_tall;        /// T+All可用资金N18(4)
  ATPAmtType frozen_all;            /// 当前所有冻结N18(4)
  ATPPartitionType te_partition_no; /// 所属分区号
  ATPAmtType
      credit_sell_frozen; /// 融券卖出冻结金额N18(4)、买高流通股票、买券还券时可全额使用
...
struct TRADE_API APIShareUnit {
  ...
  ATPBranchIDType branch_id;             /// 营业部ID
  ATPQtyType
      init_qty; /// 日初持仓量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）；对于两融类业务：不含日初融券买入量（init_crd_sell_buy_share_qty）
  ATPQtyType
      leaves_qty; /// 剩余股份数量N15(2)（包含当日买入部分,拆分合并、申购赎回）（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPQtyType
      available_qty; /// 可用股份数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPAmtType profit_loss;   /// 浮动盈亏N18(4)
  ATPAmtType market_value;  /// 市值N18(4)
  ATPAmtType cost_price;    /// 成本价N18(4)
  ATPCurrencyType currency; /// 货币种类
  ATPQtyType
      init_crd_sell_buy_share_qty; /// 日初融券买入量N15(2)；对于两融类业务:与日初持仓量(init_qty)相加才是实际的昨结算后股份持仓数量）
  ...
  ATPSecurityTypeType security_type; /// 证券类别（ATP3.1.8 开始支持）
  ATPQtyType
      etf_redemption_qty; /// 对于ETF基金表示可赎回数量，对于其他证券表示可用于ETF申购的数量（ATP3.2.1开始支持）
  ATPAmtType realize_profit_loss; /// 当日已实现的盈亏（ATP4.0.0开始支持）
...
struct TRADE_API APIIPOQtyUnit {
  ATPMarketIDType market_id; /// 市场代码
  ATPQtyType
      subscription_quota; /// 科创板申购额度（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API APIIPOQtyExUnit {
  ATPMarketIDType market_id; /// 市场代码
  ATPQtyType
      subscription_quota; /// 申购额度（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      tib_subscription_quota; /// 科创板申购额度（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API APIContractUnit {
  ...
  ATPMarketIDType market_id;     /// 市场代码
  ATPQtyType
      buy_init_value; /// 买开仓日初持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      buy_value; /// 买开仓可用持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType buy_frozen_value; /// 委托冻结
  ATPQtyType
      sell_init_value; /// 卖开仓日初持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      sell_value; /// 卖开仓可用持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      sell_frozen_value; /// 卖开仓冻结量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      cover_init_value; /// 备兑仓日初持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      cover_value; /// 备兑仓可用持仓量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      cover_frozen_value; /// 备兑仓冻结量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      accum_exercise_qty; /// 普通行权申报数量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      combi_exercise_qty; /// 合并行权申报数量，无意义（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPPositionSideType position_side; /// 持仓方向（0-权利仓，1-义务仓，2-备兑仓）
  ATPAmtType init_buy_amt; /// 日初占用买入额度N18(4)
  ATPQtyType
      init_total_position_value; /// 日初持仓量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      init_position_value; /// 日初可用持仓量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      init_combinationed_value; /// 日初已组合数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      tatol_position_value; /// 当前持仓量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      position_value; /// 当前可用持仓量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      combinationed_value; /// 已组合数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      temp_in; /// 临时调增（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      temp_out; /// 临时调减（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      open_position_value; /// 开仓数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      close_position_value; /// 平仓数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPQtyType
      exercise_qty; /// 行权申报数量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API ATPRspAccountContractFundQueryResultMsg {
  ...
  ATPAmtType royalties_in;         /// 权利金收入N18(4)
  ATPAmtType royalties_out;        /// 权利金支出N18(4)
...
struct TRADE_API APITradeCollectUnit {
  ...
  ATPQtyType
      buy_cum_qty; /// 买入累计总量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPAmtType buy_total_value_traded; /// 买入成交总金额，精确到3位小数N18(4)
  ATPPriceType sell_avg_price; /// 卖出均价N13(4)
  ATPQtyType
      sell_cum_qty; /// 卖出累计总量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API ATPRspCollectQueryResultMsg {
  ...
  ATPQtyType
      all_buy_cum_qty; /// 总买入累计总量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
  ATPAmtType
      all_buy_total_value_traded; /// 总买入成交总金额，精确到3位小数N18(4)
  ATPPriceType all_sell_avg_price; /// 总卖出均价N13(4)
  ATPQtyType
      all_sell_cum_qty; /// 总卖出累计总量（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）N15(2)
...
struct TRADE_API ATPRspSyncBizFinishOtherMsg {
  ...
  ATPReasonCodeType
      reason_code; /// 结果代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-4
                   /// 回报同步结束消息结果错误码类型，即可查询到错误描述信息
...
struct TRADE_API APIMsgCustLoginRespAccountUnit {
  ...
  ATPPartitionType
      partition_no; /// 所属分区号（默认值为0，ATP3.1.9开始支持，返回默认值表示该版本不支持）
...
struct TRADE_API APIMsgCustLoginRespFundAccountUnit {
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPBranchIDType branch_id;            /// 营业部ID
  std::vector<APIMsgCustLoginRespAccountUnit>
      account_array; /// 登入应答证券账户重复组
...
struct TRADE_API ATPRspCustLoginRespOtherMsg {
  ...
  ATPPermissonErrorCodeType
      permisson_error_code; /// 错误码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-2客户登录错误码类型，即可查询到错误描述信息
  std::vector<APIMsgCustLoginRespFundAccountUnit>
      fund_account_array;          /// 登入应答资金账户重复组
  ATPBoolType is_multi_partitions; /// 是否为一户两地账户
  ATPMultiChannelResultType multi_channel_result; /// 回报消息订阅结果
  ATPFundAccountIDType fund_account_id; /// 资金账户ID（ATP3.5 开始支持）
...
struct TRADE_API ATPRspExtRepayResultOtherMsg {
  ...
  ATPRejectReasonCodeType
      reject_reason_code; /// 拒绝原因代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-5
                          /// 拒绝原因错误码类型，即可查询到错误描述信息
  ATPTimeStampType transact_time; /// 回报时间
  ATPAmtType repay_amt;           /// 还款金额N18(4)
...
struct TRADE_API ATPReqBlockTradePricingOrderMsg {
  ...
  ATPPriceType price;              /// 委托价格N13(4)
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
  ATPPricingType pricing; /// 是否协议交易定价 1=协议交易定价申报(约定号不用填)
                          /// 2=协议交易定价成交申报(约定号必填且不可撤单）
...
struct TRADE_API ATPReqCancelBatchOrderMsg {
  ...
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPClOrdNOType
      parent_cl_ord_no; /// 批量订单母单编号，指被撤消订单的parent_cl_ord_no
  ATPMarketIDType
      market_id; /// 市场代码，开通北交所业务后必填（ATP V3.4版本开始支持）
...
struct TRADE_API ATPReqExtOptionFundTransfeOtherMsg {
  ...
  ATPCurrencyType currency;             /// 货币种类
  ATPTransferWayType
      transfer_way; /// 划拨方式 ：1-转入；2-转出；4-可划入资金查询
  ATPAmtType transfer_value; /// 划拨金额 N18(4)
  ATPRemarkType remark;      /// 备注
  ATPPasswordType password; /// 客户密码（该字段是否必填请咨询券商）
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
...
struct TRADE_API ATPRspExtQueryResultExerciseProfitLossMsg {
  ...
  ATPSecurityIDType security_id;          /// 证券代码
  ATPQtyType
      order_qty; /// 行权申报数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
...
struct TRADE_API ATPReqHKDesignationTransferOrderMsg {
  ...
  ATPSecurityIDType security_id; /// 证券代码
  ATPMarketIDType market_id;     /// 市场代码
  ATPSideType side; /// 买卖方向 'J'=DesignationTransfer，转托管
                    /// 'K'=RevertDesignationTransfer，反向转托管
  ATPQtyType
      order_qty; /// 申报数量N15(2)
                 /// （股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPEnforceFlagType enforce_flag; /// 风险强制标识（已弃用）
  ...
  ATPPBUIDType
      transferee_pbu_id; /// 转托管，转入交易单元代码；反向转托管，转出交易单元
...
struct TRADE_API ATPReqExternalInsTETransFundReqMsg {
  ...
  ATPUserInfoType user_info;         /// 用户私有信息
  ATPFundPropertyType fund_property; /// 资金属性：'0'=T+0 '1'=T+1
                                     /// ，可指定要划拨的资金属性，当不填时按原有逻辑T+1处理。（ATP
                                     /// V4.0.0版本开始支持）
...
struct TRADE_API ATPRspExternalInsTETransFundRespMsg {
  ...
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPBranchIDType branch_id;            /// 营业部ID
  ExternalInsErrorCodeType
      external_ins_error_code; /// 外部指令错误代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型-7
                               /// 外部指令拒绝原因错误码类型，即可查询到错误描述信息
  ATPSeqNumType client_seq_id; /// 用户系统消息序号
  ATPUserInfoType user_info;   /// 用户私有信息
...
struct TRADE_API ATPReqCustPasswdModifyMsg {
  ATPExtraData extra_data; /// 扩展字段
  ATPCustIDType
      cust_id; /// 客户号ID （cust_id、fund_account_id+branch_id两者必选填其一）
  ATPFundAccountIDType
      fund_account_id; /// 资金账户ID
                       /// （cust_id、fund_account_id+branch_id两者必选填其一）
  ATPBranchIDType
      branch_id; /// 营业部ID
                 /// （cust_id、fund_account_id+branch_id两者必选填其一）
...
struct TRADE_API ATPReqExternalQueryOptionUnderlyingSecurityInfoMsg {
  ...
  ATPTotalNumType
      return_num; /// 查询返回数量（默认值为0，表示按能返回的最大数量返回，具体数量请咨询券商）
...
struct TRADE_API APIOptionOrderUnit {
  ...
  ATPParticularFlagsType
      particular_flags; /// 特殊委托标识，右起第一个bit位是夜市委托标志位：0-正常委托、1-夜市委托，目前默认为0；右起第二个bit位是协议行权标志位：0-非协议行权、1-协议行权（ATP3.3.0开始支持）
...
struct TRADE_API ApiSecurityInfoArray {
  ...
  ATPQtyType buy_qty_lower_limit;        /// 限价买数量下限N15(2)
  ATPQtyType sell_qty_lower_limit;       /// 限价卖数量下限N15(2)
  ATPBoolType day_trading;               /// 是否支持回转交易
  ATPBoolType has_price_limit;           /// 涨跌幅限制
  ATPSecurityStatusType
      security_status; /// 证券状态（按bit位设置对应的证券状态，例：129表示该证券状态为0-正常、7-上市首日）（ATP3.1.10.2开始支持）
  ATPQtyType
      market_buy_qty_upper_limit; /// 市价买数量上限N15(2)（ATP3.1.10开始支持）
  ATPQtyType
      market_buy_qty_lower_limit; /// 市价买数量下限N15(2)（ATP3.1.10开始支持）
  ATPQtyType
      market_sell_qty_upper_limit; /// 市价卖数量上限N15(2)（ATP3.1.10开始支持）
  ATPQtyType
      market_sell_qty_lower_limit; /// 市价卖数量下限N15(2)（ATP3.1.10开始支持）
  ATPQtyType buy_qty_upper_limit; /// 限价买数量上限N15(2)（ATP3.1.10开始支持）
  ATPQtyType sell_qty_upper_limit; /// 限价卖数量上限N15(2)（ATP3.1.10开始支持）
  ATPQtyType buy_qty_unit; /// 限价买数量单位N15(2)(ATP3.3.0开始支持)
  ATPQtyType sell_qty_unit; /// 限价卖数量单位N15(2)(ATP3.3.0开始支持)
  ATPQtyType market_buy_qty_unit; /// 市价买数量单位N15(2)(ATP3.3.0开始支持)
  ATPQtyType market_sell_qty_unit; /// 市价卖数量单位N15(2)(ATP3.3.0开始支持)
};
...
struct TRADE_API ApiShareArrayEx {
  ...
  ATPQtyType
      init_qty; /// 日初持仓量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      leaves_qty; /// 剩余股份数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)（包含当日买入部分）
  ATPQtyType
      available_qty; /// 可用股份数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ...
  ATPQtyType
      stock_buy; /// 股份买入解冻(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      stock_sale; /// 股份卖出冻结(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
...
struct TRADE_API ATPReqAlgoParentOrderMsg {
  ...
  ATPSideType side;              /// 买卖方向
  ATPQtyType
      order_qty; /// 母单数量N15(2)（股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张）
  ATPPriceType
      price; /// 母单的限价N13(4)
             /// ;表示算法子单委托价格的买入上限或卖出下限；填0表示母单市价，即不限制子单价格上下限
  ...
  ATPTimeType
      start_time; /// 算法开始时间
                  /// （填0表示从当前时间开始）格式YYYYMMDDHHmmSSsss;例：20201124093000000
  ATPTimeType
      end_time; /// 算法结束时间
                /// （填0表示结束时间由“执行时长”参数决定）格式YYYYMMDDHHmmSSsss;例：20201124150000000
  ATPAlgoDurationSecType
      duration_sec; /// 算法执行长度(单位秒)
                    /// （当结束时间为0时，此参数生效），算法系统会自动剔除非交易时间。如开始时间对应9:00:00，此参数为300秒，对应的有效执行时间段是9:30:00~9:35:00
  ATPAlgoPartRateType
      part_rate; /// 算法参与比例  N5(4)
                 /// ，值域[0,10000]，如值2000表示量比20%，0或10000表示没有参与比例限制
  ATPStringType extra_params; /// 算法扩展参数
                              /// ;Json格式，如设置单笔委托最小金额为10000元，对应值:
                              /// {“min_amount”:10000}
...
struct TRADE_API ATPReqExternalQueryAlgoParentMsg {
  ...
  ATPReturnSeqType
      return_seq; /// 返回顺序，按时间排序 ,例如，1=按时间正序，2=按时间倒序
...
struct TRADE_API ATPRspAlgoParentExecReportMsg {
  ...
  ATPIndexType index;         /// 回报记录号
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（ATP3.2.3开始支持）
...
struct TRADE_API ATPRspExternalQueryResultAlgoParentMsg {
  ...
  ATPExtraData extra_data;                  /// 扩展字段
  ATPReportIndexType
      last_index; /// 最后一笔查询结果的索引号，当 “LastIndex +1 ==
                  /// TotalNum”时，表示已经查到最后的记录；组合个数为0时，该值为-1
  ATPTotalNumType total_num; /// 订单记录总数
...
struct TRADE_API ATPReqExternalQueryAlgoOrderMsg {
  ...
  ATPBranchIDType branch_id;            /// 营业部ID
  ATPAccountIDType
      account_id; /// 证券账户ID（一户两地账户此字段必填）（ATP3.1.7版本开始支持此字段非必填）
  ATPClientSeqIDType client_seq_id; /// 用户系统消息序号
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPUserInfoType user_info; /// 用户私有信息
  ...
  ATPMarketIDType
      market_id; /// 证券所属市场
                 /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPSecurityIDType
      security_id; /// 证券代码证券代码
                   /// （默认值为空字符串，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPBusinessTypeType
      business_type; /// 业务类型业务类型
                     /// （默认值为0，表示查所有，一户两地账户表示查单个证券账户下所有）
  ATPSideType side; /// 买卖方向
  ATPOrderQueryConditionType
      order_query_condition; /// 委托查询条件
...
struct TRADE_API ATPReqBondConsultTradeOrderMsg {
  ...
  ATPQtyType
      order_qty; /// 申报数量N15(2)(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)
  ATPOrderWayType order_way; /// 委托方式（是否必填以及字典项请咨询券商）
  ATPTradeReportTypeType
      trade_report_type; /// 成交申报类型（默认值为0，表示提交成交申报）
  ATPTransAffairTypeType
      trade_report_trans_type; /// 成交申报事务类别（默认值为0，表示普通申报）
  ATPClOrdIDType
      trade_report_ref_id; /// 原客户成交申报编号（成交申报类型trade_report_type为2-接受成交申报、3-拒绝成交申报时，该字段必填）
...
struct TRADE_API ATPRspBondConsultTradeERMsg {
  ...
  ATPPriceType price;                   /// 委托价格,N13(4)
  ATPQtyType
      order_qty; /// 委托数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      leaves_qty; /// 未成交数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPQtyType
      cum_qty; /// 累计成交数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
  ATPSideType side;               /// 买卖方向
  ATPTimeStampType transact_time; /// 回报时间
  ATPUserInfoType user_info;      /// 用户私有信息
  ATPOrderIDType order_id;        /// 交易所订单编号, 取值为数字
  ...
  ATPQtyType
      last_qty; /// 成交数量(股票为股、基金为份、上海债券默认为张（使用时请务必与券商确认），其他为张)N15(2)
...
struct TRADE_API ATPReqExtQueryOrderForwardInfoMsg {
  ...
  ATPAccountIDType
      counterparty_account_id; /// 对手方证券账户（默认值为空，表示查所有）
  ATPClOrdIDType orig_cl_ord_id; /// 原客户成交申报编号（默认值为空，表示查所有）
  ATPReportIndexType query_index; /// 起始查询索引号（默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 指定查询返回数量（默认值为0，表示按能返回的最大数量返回，具体数量请咨询券商）
 ...
 *  @brief ETF信息查询结果组合
 */
struct TRADE_API ApiETFInfoArray {
  ATPMarketIDType market_id;             /// 市场代码
  ATPSecurityIDType security_id;         /// ETF代码
  ATPSecuritySymbolType security_symbol; /// 证券简称
  ATPSecurityTypeType security_type;     /// 证券类别
  ATPPrTypeType pr_type;     /// 申赎类型（1-申赎，2-实物申赎）
  ATPBoolType is_pd_broker;  /// 是否有PD券商资格
  ATPBoolType is_purchase;   /// 是否允许申购
  ATPBoolType is_redemption; /// 是否允许赎回
  ATPQtyType purchase_redemption_unit;    /// ETF申购赎回单位N15(2)
  ATPPriceType estimate_cash_component;   /// ETF股票篮现金差额N13(4)
  ATPMaxCashRatioType max_cash_ratio;     /// ETF最大现金替代比例N6(5)
  ATPTotalNumType total_record_num;       /// ETF股票篮记录数
  ATPPriceType nav;                       /// ETF单位净值N13(4)
  ATPAmtType nav_per_cu;                  /// ETF基准单位净值N18(4)
  ATPQtyType purchase_limit_per_user;     /// 单账户累计申购上限N15(2)
  ATPQtyType redemption_limit_per_user;   /// 单账户累计赎回上限N15(2)
  ATPQtyType net_purchase_limit_per_user; /// 单账户净申购上限N15(2)
  ATPQtyType net_redemption_limit_per_user; /// 单账户净赎回上限N15(2)
 ...
 *  @brief ETF信息查询消息
 */
struct TRADE_API ATPReqExtQueryETFInfoMsg {
  ATPSeqNumType client_seq_id; /// 用户系统消息序号
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPUserInfoType user_info; /// 用户私有信息
  ATPMarketIDType market_id; /// 市场代码（默认值为0，表示查所有）
  ATPSecurityIDType security_id; /// ETF代码（默认值为空字符串，表示查所有）
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 查询返回数量
                  /// （默认值为0，表示按能返回的最大数量返回，具体数量请咨询券商）
  ATPPrTypeType pr_type; /// 申赎类型（默认值为0，表示查所有）

  ATPReqExtQueryETFInfoMsg();
};

/**
 *  @brief ETF信息查询结果
 */
struct TRADE_API ATPRspExtQueryResultETFInfoMsg {
  ATPSeqNumType client_seq_id; /// 用户系统消息序号
  ATPQueryResultCodeType
      query_result_code; /// 查询结果代码；可调用GetErrorInfo错误码查询函数，传入错误码及错误码类型
                         /// -3 查询结果错误码类型，即可查询到错误描述信息
  ...
  ATPReportIndexType last_index; /// 最后一笔查询结果的索引号
  ATPLengthType total_num;       /// 组合个数
  std::vector<ApiETFInfoArray> etf_info_array; /// 查询组合

  ATPRspExtQueryResultETFInfoMsg();
};

/**
 *  @brief ETF成分股信息查询结果组合
 */
struct TRADE_API ApiETFComponentInfoArray {
  ATPMarketIDType component_market_id;             /// 成分股市场代码
  ATPSecurityIDType component_security_id;         /// 成分股代码
  ATPSecuritySymbolType component_security_symbol; /// 成分股简称
  ATPSubstituteFlagType substitute_flag;           /// 现金替代标志
  ATPPremiumRatioType premium_ratio;               /// 申购溢价比例N7(5)
  ATPPremiumRatioType redemption_premium_ratio;    /// 赎回折价比例N7(5)
  ATPQtyType component_share_qty; /// 成分股数量，最小单位度量（股，张）
  ATPAmtType purchase_cash_substitute;   /// 申购现金替代金额N18(4)
  ATPAmtType redemption_cash_substitute; /// 赎回现金替代金额N18(4)

  ApiETFComponentInfoArray();
};

/**
 *  @brief ETF成分股信息查询
 */
struct TRADE_API ATPReqExtQueryETFComponentInfoMsg {
  ATPSeqNumType client_seq_id; /// 用户系统消息序号
  ATPClientFeatureCodeType
      client_feature_code; /// 终端识别码（该字段是否必填请咨询券商）
  ATPUserInfoType user_info;     /// 用户私有信息
  ...
  ATPSecurityIDType security_id; /// ETF代码
  ATPSecurityIDType
      component_security_id; /// 成分股代码（默认值为0，表示查所有）
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 查询返回数量
                  /// （默认值为0，表示按能返回的最大数量返回，具体数量请咨询券商）
  ATPPrTypeType pr_type; /// 申赎类型（默认值为1，表示查普通申赎）

  ATPReqExtQueryETFComponentInfoMsg();
};

/**
 *  @brief ETF成分股信息查询结果
 */
struct TRADE_API ATPRspExtQueryResultETFComponentInfoMsg {
  ATPMarketIDType market_id;             /// 市场代码
  ATPSecurityIDType security_id;         /// ETF代码
  ATPSecuritySymbolType security_symbol; /// 证券简称
  ATPSeqNumType client_seq_id;           /// 用户系统消息序号
  ...
  ATPReportIndexType last_index; /// 最后一笔查询结果的索引号
  ATPLengthType total_num;       /// 组合个数
  std::vector<ApiETFComponentInfoArray> etf_component_info_array; /// 查询组合
  ATPPrTypeType pr_type; /// 申赎类型

  ATPRspExtQueryResultETFComponentInfoMsg();
};

/**
 *  @brief 新股中签结果查询
 */
struct TRADE_API ATPReqNewShareHitQueryMsg {
  ATPSeqNumType client_seq_id;          /// 用户系统消息序号
  ATPBranchIDType branch_id;            /// 营业部ID
  ATPCustIDType cust_id;                /// 客户号ID
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ...
  ATPSecurityIDType security_id; /// 证券代码
  ATPDate8Type
      start_date; /// 申购开始日期（日期格式YYYYMMDD)，默认值为0，表示查所有
  ATPDate8Type end_date; /// 申购结束日期（日期格式YYYYMMDD)，默认值为当前时间
  ATPDate8Type hit_date; /// 中签日期（日期格式YYYYMMDD)（是否可用请咨询券商）
  ATPUserInfoType user_info;                    /// 用户私有信息
  ATPExtraData extra_data;                      /// 扩展字段
  ATPClientFeatureCodeType client_feature_code; /// 终端识别码
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType return_num; /// 查询返回数量 （为空情况默认数量请咨询券商）

  ATPReqNewShareHitQueryMsg();
};

/**
 *  @brief 新股中签结果查询结果组合
 */
struct TRADE_API APINewShareHitUnit {
  ATPBranchIDType branch_id;            /// 营业部ID（取DXS返回内容）
  ATPFundAccountIDType fund_account_id; /// 资金账户ID（取DXS返回内容）
  ATPAccountIDType account_id;   /// 证券账户ID（取DXS返回内容）
  ATPDate8Type trade_date;       /// 申购日期
  ATPSecurityIDType security_id; /// 证券代码
  ATPSecuritySymbolType security_symbol; /// 证券简称
  ATPMarketIDType market_id;             /// 市场代码
  ATPSecurityTypeCharType security_type; /// 证券类别（字段值请咨询券商）
  ATPPriceType price;                    /// 发行价N13(4)
  ATPDate8Type hit_date;   /// 中签日期（日期格式YYYYMMDD)
  ATPQtyType hit_qty;      /// 中签数量N15(2)
  ATPAmtType hit_value;    /// 中签金额、应缴金额N18(4)
  ATPDate8Type pay_date;   /// 缴款日期（日期格式YYYYMMDD)
  ATPQtyType pay_qty;      /// 已缴款数量N15(2)
  ATPAmtType pay_value;    /// 已缴款金额N18(4)
  ATPQtyType give_up_qty;  /// 放弃数量N15(2)
  ATPQtyType last_qty;     /// 交易所确认数量N15(2)
  ATPAmtType frozen_value; /// 冻结金额N18(4)
 ...
 *  @brief 新股中签结果查询结果
 */
struct TRADE_API ATPRspNewShareHitQueryResultMsg {
  ATPCustIDType cust_id;                /// 客户号ID（同入参的cust_id）
  ATPFundAccountIDType fund_account_id; /// 资金账户ID（同入参的fund_account_id）
  ATPAccountIDType account_id; /// 证券账户ID（同入参的account_id）
  ATPSeqNumType client_seq_id; /// 用户系统消息序号
  ATPQueryResultCodeType query_result_code; /// 查询结果代码
  ATPUserInfoType user_info;                /// 用户私有信息
  ATPExtraData extra_data;                  /// 扩展字段
  ATPReportIndexType last_index; /// 最后一笔查询结果的索引号
  ATPTotalNumType total_num;     /// 订单记录总数
  std::vector<APINewShareHitUnit> new_share_hit_unit; /// 查询结果组合

  ATPRspNewShareHitQueryResultMsg();
};

/**
 *  @brief 偿还明细查询
 */
struct TRADE_API ATPReqExtQueryRepaymentDetailMsg {
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPBranchIDType branch_id;            /// 营业部ID
  ATPDate8Type associate_date;          /// 关联日期
  ATPRepaymentType item;                /// 偿还类型
  ATPSecurityIDType security_id;        /// 证券代码
  ATPMarketIDType market_id;            /// 交易市场
  ATPReportIndexType
      query_index; /// 起始查询索引号 （默认值为0，表示从头开始查）
  ATPTotalNumType
      return_num; /// 查询返回数量
                  /// （默认值为0，表示按能返回的最大数量返回。受单次最大返回参数控制，可配置。）
  ATPSeqNumType client_seq_id;                  /// 用户系统消息序号
  ATPUserInfoType user_info;                    /// 用户私有信息
  ATPPasswordType password;                     /// 客户密码
  ATPExtraData extra_data;                      /// 扩展字段
  ...
  ATPReqExtQueryRepaymentDetailMsg();
};

/**
 *  @brief 偿还明细查询结果组合
 */
struct TRADE_API ApiRepaymentDetailArray {
  ATPAccountIDType account_id;   /// 证券账户ID
  ATPMarketIDType market_id;     /// 交易市场
  ATPSecurityIDType security_id; /// 证券代码
  ATPAmtType amt;                /// 资金调整量N18(4)
  ATPQtyType qty;                /// 股份调整量N15(2)
  ATPAmtType opening_amt;        /// 开仓金额N18(4)
  ATPQtyType opening_qty;        /// 开仓数量N15(2)
  ATPDate8Type opening_date;     /// 开仓日期
  ATPAmtType repayment_amt; /// 已还金额（累计已偿还金额）N18(4)
  ATPQtyType repayment_qty; /// 已还数量（累计已偿还数量）N15(2)
  ATPRepaymentType item;    /// 偿还类型
  ATPLiabilityDetailType detail_type;    /// 负债明细类型
  ATPCreditIdentificationType credit_id; /// 信用标识
  ATPOpeningSerialNumType associate_serial_num; /// 关联流水号（关联主合约）
  ATPDate8Type associate_date; /// 关联日期（关联主合约）
  ATPOpeningSerialNumType contract_serial_no; /// 合约流水号（本笔委托流水号）
  ATPDate8Type detail_date; /// 委托日期（流水生成时间）
  ATPClOrdIDType
      contract_bail_serial_num; /// 委托序号（本笔偿还生成的报盘合同号）
  ATPExecIDType exec_id;    /// 执行编号
  ATPClOrdNOType cl_ord_no; /// 客户订单编号
  ATPCommentsType comments; /// 备注信息

  ApiRepaymentDetailArray();
};

/**
 *  @brief 偿还明细查询结果
 */
struct TRADE_API ATPRspExtQueryResultRepaymentDetailMsg {
  ATPReportIndexType last_index;        /// 最后一笔查询结果的索引号
  ATPTotalNumType total_num;            /// 订单记录总数（总条数）
  ATPCustIDType cust_id;                /// 客户号ID
  ATPFundAccountIDType fund_account_id; /// 资金账户ID
  ATPBranchIDType branch_id;            /// 营业部ID
  ATPSeqNumType client_seq_id;          /// 用户系统消息序号
  ATPUserInfoType user_info;            /// 用户私有信息
  ATPExtraData extra_data;              /// 扩展字段
  std::vector<ApiRepaymentDetailArray> order_array; /// 偿还明细查询结果组合

  ATPRspExtQueryResultRepaymentDetailMsg();
};
