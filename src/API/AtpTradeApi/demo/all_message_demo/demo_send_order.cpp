...
std::map<ATPClientSeqIDType, ATPReqMarginNoTradeOrderMsg *>
    seq_margin_no_trade_map;
...
std::map<ATPClientSeqIDType, ATPReqBondDistributionOrderMsg *>
    seq_bond_distribution_map;
std::map<ATPClientSeqIDType, ATPReqOptionAuctionOrderMsg *>
    seq_option_auction_map;

std::map<ATPClientSeqIDType, ATPReqOptionQuoteOrderMsg *> seq_quote_order_map;
std::map<ATPClientSeqIDType, ATPReqETFRedemptionOrderMsg *>
    seq_etf_redemption_map;
...
std::map<ATPClientSeqIDType, ATPReqOptionExerciseOrderMsg *>
    seq_option_exercise_map;
std::map<ATPClientSeqIDType, ATPReqCoveredLockOrderMsg *>
    seq_covered_lock_order_map;
std::map<ATPClientSeqIDType, ATPReqTurnToDisposalOrderMsg *>
    seq_turn_to_disposal_map;

std::map<ATPClientSeqIDType, ATPReqDesignationOrderMsg *> seq_designation_map;
std::map<ATPClientSeqIDType, ATPReqDesignatedTransactionOrderMsg *>
    seq_designated_transaction_map;
...
std::map<ATPClientSeqIDType, ATPReqPasswordServiceOrderMsg *>
    seq_password_service_map;
std::map<ATPClientSeqIDType, ATPReqWarrantExerciseOrderMsg *>
    seq_warrant_exercise_map;
std::map<ATPClientSeqIDType, ATPReqStructuredFundOrderMsg *>
    seq_structured_fund_map;
std::map<ATPClientSeqIDType, ATPReqOptionCombinationOrderMsg *>
    seq_combination_map;
std::map<ATPClientSeqIDType, ATPReqTibAfterHourAuctionOrderMsg *>
    seq_tib_after_hour_auction_map;
std::map<ATPClientSeqIDType, ATPReqPledgeInOrOutOrderMsg *>
    seq_pledge_in_or_out_map;
...
std::map<ATPClientSeqIDType, ATPReqOptionCancelOrderMsg *>
    seq_option_cancel_map;
std::map<ATPClientSeqIDType, ATPReqCoverMaxOrderQtyQueryMsg *>
    seq_cover_max_order_qty_query_map;
std::map<ATPClientSeqIDType, ATPReqExtOptionFundTransfeOtherMsg *>
    seq_ext_option_fund_transfe_other_map;
std::map<ATPClientSeqIDType, ATPReqOrderQueryMsg *> seq_order_query_map;
std::map<ATPClientSeqIDType, ATPReqTradeOrderQueryMsg *>
    seq_trade_order_query_map;
...
std::map<ATPClientSeqIDType, ATPReqAccountContractShareQueryMsg *>
    seq_account_contract_share_query_map;
std::map<ATPClientSeqIDType, ATPReqAccountContractFundQueryMsg *>
    seq_account_contract_fund_query_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryExerciseProfitLossMsg *>
    seq_ext_query_exercise_profit_loss_map;
std::map<ATPClientSeqIDType, ATPReqTradeCollectQueryMsg *>
    seq_trade_collect_query_map;
std::map<ATPClientSeqIDType, ATPReqTIBIPOQtyQueryMsg *>
    seq_tib_ipo_qty_query_map;
std::map<ATPClientSeqIDType, ATPReqOptionCombinationExerciseOrderMsg *>
    seq_combination_exercise_map;
std::map<ATPClientSeqIDType, ATPReqNewMaxOrderQtyQueryMsg *>
    seq_new_max_order_qty_query_map;
...
std::map<ATPClientSeqIDType, ATPReqExtFundTransferOtherMsg *>
    seq_ext_fund_transfer_map;
...
std::map<ATPClientSeqIDType, ATPReqCombinationQueryMsg *>
    seq_combination_query_map;
std::map<ATPClientSeqIDType, ATPReqAfterHoursPricingOrderMsg *>
    seq_after_hours_pricing_map;
std::map<ATPClientSeqIDType, ATPReqBlockTradeIntentionOrderMsg *>
    seq_block_trade_intention_map;
std::map<ATPClientSeqIDType, ATPReqBlockTradeTransactionOrderMsg *>
    seq_block_trade_transaction_map;
std::map<ATPClientSeqIDType, ATPReqBlockTradePricingOrderMsg *>
    seq_block_trade_pricing_map;
std::map<ATPClientSeqIDType, ATPReqBlockTradeCancelOrderMsg *>
    seq_block_trade_cancel_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryContractSpecificationsMsg *>
    seq_ext_query_contract_specifications_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryCreditAmountMsg *>
    seq_ext_query_credit_amount_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryMarginUseableMsg *>
    seq_ext_query_margin_useable_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryFundLiabilityMsg *>
    seq_ext_query_fund_liability_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryShareLiabilityMsg *>
    seq_ext_query_share_liability_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryContractSpecificationsManagerMsg *>
    seq_ext_query_contract_specifications_manager_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryMarginUnderlyingMsg *>
    seq_ext_query_margin_underlying_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryCreditInfoMsg *>
    seq_ext_query_credit_info_map;
std::map<ATPClientSeqIDType, ATPReqExtQueryFundAssetsInfoMsg *>
    seq_ext_query_fund_assets_info_map;
std::map<ATPClientSeqIDType, ATPReqHKStocksThroughAuctionOrderMsg *>
    seq_hkstocksthrough_auction_map;
std::map<ATPClientSeqIDType, ATPReqHKVotingOrderMsg *> seq_hk_voting_map;
std::map<ATPClientSeqIDType, ATPReqHKCorporateActionOrderMsg *>
    seq_hk_corporate_action_map;
std::map<ATPClientSeqIDType, ATPReqHKDesignationTransferOrderMsg *>
    seq_hk_designation_transfer_map;
std::map<ATPClientSeqIDType, ATPReqHKCorporateActionCancelOrderMsg *>
    seq_hk_corporate_action_cancel_map;

std::map<ATPClientSeqIDType, ATPReqOptionCoveredTransUncoveredOrderMsg *>
    seq_optioncoveredtransuncoveredorder_map; // ///< 期权普通与备兑互转订单
std::map<ATPClientSeqIDType, ATPReqExtQueryCombinExerciseMaxOrderQtyMsg *>
    seq_extquerycombinexercisemaxorderqty_map; // ///<
                                               // 合并行权最大可委托数查询消息
std::map<ATPClientSeqIDType, ATPReqExtQueryCombinExerciseProfitLossMsg *>
    seq_extquerycombinexerciseprofitloss_map; // ///< 合并行权预估盈亏查询消息
std::map<ATPClientSeqIDType,
         ATPReqExternalQueryOptionCombinationMaxOrderQtyMsg *>
    seq_externalqueryoptioncombinationmaxorderqty_map; // ///<
                                                       // 期权组合策略最大可委托数查询消息

std::map<ATPClientSeqIDType, ATPReqCustPasswdModifyMsg *>
    seq_custpasswdmodify_map; // ///< 客户密码修改请求
std::map<ATPClientSeqIDType, ATPReqExternalInsTETransFundReqMsg *>
    seq_externalinstetransfundreq_map; // ///< 按证券账户划转资金请求消息
std::map<ATPClientSeqIDType, ATPReqExtFundQueryMsg *>
    seq_extfundqueryreq_map; // ///< 增强资金查询请求消息
std::map<ATPClientSeqIDType, ATPReqThirdPartPassThroughMsg *>
    seq_third_part_pass_through_map;
std::map<ATPClientSeqIDType, ATPReqTradeOrderExQueryMsg *>
    seq_trade_order_ex_query_map;
std::map<ATPClientSeqIDType, ATPReqBankSecuritiesFundTransferOtherMsg *>
    seq_bank_securities_fund_transfer_other_map;
// 使用到的全局变量
// 使用到的全局变量
...
uint64_t GenerateClientSeqID() {
  ...
  // std::chrono::system_clock::now(); std::chrono::time_point<
  // std::chrono::system_clock, std::chrono::nanoseconds>  ns =
...
void SendDesignatedTransaction() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqDesignatedTransactionOrderMsg *p =
      new ATPReqDesignatedTransactionOrderMsg;
...
void SendOptionCombinationExerciseOrder() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqOptionCombinationExerciseOrderMsg *p =
      new ATPReqOptionCombinationExerciseOrderMsg;
...
void SendReduceHoldingTransfer() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqReduceHoldingTransferOrderMsg *p =
      new ATPReqReduceHoldingTransferOrderMsg;
...
void SendReduceHoldingTransferCancel() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqReduceHoldingTransferCancelOrderMsg *p =
      new ATPReqReduceHoldingTransferCancelOrderMsg;
...
void SendExtOptionFundTransfer() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqExtOptionFundTransfeOtherMsg *p =
      new ATPReqExtOptionFundTransfeOtherMsg;
...
void SendExtQueryContractSpecifications() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqExtQueryContractSpecificationsMsg *p =
      new ATPReqExtQueryContractSpecificationsMsg;
...
void SendExtQueryContractSpecificationsManager() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqExtQueryContractSpecificationsManagerMsg *p =
      new ATPReqExtQueryContractSpecificationsManagerMsg;
...
void SendAccountContractShareQuery() {
  ...
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqAccountContractShareQueryMsg *p =
      new ATPReqAccountContractShareQueryMsg;
...
void SendExtQueryExerciseProfitLoss() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqExtQueryExerciseProfitLossMsg *p =
      new ATPReqExtQueryExerciseProfitLossMsg;
...
void SendBlockTradeTransaction() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqBlockTradeTransactionOrderMsg *p =
      new ATPReqBlockTradeTransactionOrderMsg;
...
void SendHKStocksThroughAuction() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqHKStocksThroughAuctionOrderMsg *p =
      new ATPReqHKStocksThroughAuctionOrderMsg;
...
void SendHKDesignationTransfer() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqHKDesignationTransferOrderMsg *p =
      new ATPReqHKDesignationTransferOrderMsg;
...
void SendHKCorporateActionCancel() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqHKCorporateActionCancelOrderMsg *p =
      new ATPReqHKCorporateActionCancelOrderMsg;
...
void SendAgwMsgOptionCoveredTransUncoveredOrder() {
  ...
  ATPReqOptionCoveredTransUncoveredOrderMsg *p =
      new ATPReqOptionCoveredTransUncoveredOrderMsg;
  ...
  SET(p->client_feature_code,
      client_feature_code); /////< 终端识别码（保留）。【该字段启用需特殊版本】
                            ///（非必填）
...
void SendAgwMsgExtQueryCombinExerciseMaxOrderQty() {
  ...
  ATPReqExtQueryCombinExerciseMaxOrderQtyMsg *p =
      new ATPReqExtQueryCombinExerciseMaxOrderQtyMsg;
...
void SendAgwMsgExtQueryCombinExerciseProfitLoss() {
  ...
  ATPReqExtQueryCombinExerciseProfitLossMsg *p =
      new ATPReqExtQueryCombinExerciseProfitLossMsg;
...
void SendAgwMsgExternalQueryOptionCombinationMaxOrderQty() {
  ...
  ATPReqExternalQueryOptionCombinationMaxOrderQtyMsg *p =
      new ATPReqExternalQueryOptionCombinationMaxOrderQtyMsg;
  ...
  if (!ATPCoveredOrUncoveredConst::IsValid(leg_covered_or_uncovered1)) {
    std::cout << (int)leg_covered_or_uncovered1
              << " leg_covered_or_uncovered1 not Valid\n";
  }
...
void SendAgwExternalInsTETransFundReq() {
  ...
  ATPReqExternalInsTETransFundReqMsg *p =
      new ATPReqExternalInsTETransFundReqMsg;
  ...
  SET(p->client_feature_code,
      client_feature_code); /////< 终端识别码（保留）。【该字段启用需特殊版本】
                            ///（非必填）
  SET(p->user_info,
      user_info); /////< 用户私有信息 （非必填，默认值 "api demo"）
...
void SendBankSecuritiesFundTransfer() {
  ATPClientSeqIDType seq_id = GenerateClientSeqID();
  ATPReqBankSecuritiesFundTransferOtherMsg *p =
      new ATPReqBankSecuritiesFundTransferOtherMsg;
