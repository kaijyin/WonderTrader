...
std::ostream &operator<<(std::ostream &out,
                         const std::vector<APIExerciseProfitLossLegType> &v) {
...
void DemoATPTradeHandler::OnRspOrderStatusAck(
    const ATPRspOrderStatusAckMsg &order_status_ack) {
  std::cout << "order_status_ack : " << std::endl;
  std::cout << "partition : " << (int32_t)order_status_ack.partition
            << " index : " << order_status_ack.index
            ...
            << (int32_t)order_status_ack.covered_or_uncovered
            << " account_sub_code : " << order_status_ack.account_sub_code
            << " quote_flag:" << (int32_t)order_status_ack.quote_flag
            << std::endl;
}

void DemoATPTradeHandler::OnRspQuoteStatusAck(
    const ATPRspQuoteStatusAckMsg &order_status_ack) {
  std::cout << "OnRspQuoteStatusAck : " << std::endl;
}

void DemoATPTradeHandler::OnRspNoLegsStatusInternalAck(
    const ATPRspNoLegsStatusAckMsg &order_status_ack) {
  std::cout << "OnRspNoLegsStatusInternalAck : " << std::endl;
}

void DemoATPTradeHandler::OnRspNoLegsStatusAck(
    const ATPRspNoLegsStatusAckMsg &order_status_ack) {
  std::cout << "OnRspNoLegsStatusAck : " << std::endl;
}

void DemoATPTradeHandler::OnRspQuoteOrderQueryResult(
    const ATPRspQuoteQueryResultMsg &result) {
  std::cout << "OnRspQuoteOrderQueryResult : " << std::endl;
}

void DemoATPTradeHandler::OnRspCombinationPositionQueryResult(
    const ATPRspCombinationQueryResultMsg &result) {
...
void DemoATPTradeHandler::OnRspCashAuctionTradeER(
  ...
  std::cout << "partition : " << (int32_t)cash_auction_trade_er.partition
            << " index : " << cash_auction_trade_er.index << " business_type : "
            << (int32_t)cash_auction_trade_er.business_type
            ...
            << " total_value_traded : "
            << cash_auction_trade_er.total_value_traded
            << " fee : " << cash_auction_trade_er.fee
            << " cash_margin : " << cash_auction_trade_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspCreditTradeER(
    const ATPRspCreditTradeERMsg &credit_trade_er) {
...
void DemoATPTradeHandler::OnRspMarginRepayTradeER(
    const ATPRspMarginRepayTradeERMsg &margin_trade_repay_er) {
  std::cout << "margin_trade_repay_er : " << std::endl;
  std::cout << "partition : " << (int32_t)margin_trade_repay_er.partition
            << " index : " << margin_trade_repay_er.index << " business_type : "
            << (int32_t)margin_trade_repay_er.business_type
            ...
            << " total_value_traded : "
            << margin_trade_repay_er.total_value_traded
            << " fee : " << margin_trade_repay_er.fee
            << " cash_margin : " << margin_trade_repay_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspOptionAuctionTradeER(
    const ATPRspOptionAuctionTradeERMsg &option_auction_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)option_auction_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)option_auction_trade_er.business_type
            ...
            << " total_value_traded : "
            << option_auction_trade_er.total_value_traded
            << " fee : " << option_auction_trade_er.fee
            << " position_effect : " << option_auction_trade_er.position_effect
            << " covered_or_uncovered : "
            << (int32_t)option_auction_trade_er.covered_or_uncovered
            << " account_sub_code : "
            << option_auction_trade_er.account_sub_code
            << " quote_flag:" << (int32_t)option_auction_trade_er.quote_flag
            << std::endl;
}

void DemoATPTradeHandler::OnRspRepoAuctionTradeER(
    const ATPRspRepoAuctionTradeERMsg &repo_auction_trade_er) {
  std::cout << "repo_auction_trade_er : " << std::endl;
  std::cout << "partition : " << (int32_t)repo_auction_trade_er.partition
            << " index : " << repo_auction_trade_er.index << " business_type : "
            << (int32_t)repo_auction_trade_er.business_type
            ...
            << " total_value_traded : "
            << repo_auction_trade_er.total_value_traded
            << " fee : " << repo_auction_trade_er.fee
            << " maturity_date : " << repo_auction_trade_er.maturity_date
            << std::endl;
}

void DemoATPTradeHandler::OnRspETFRedemptionTradeER(
    const ATPRspETFRedemptionTradeERMsg &etf_redemption_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)etf_redemption_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)etf_redemption_trade_er.business_type
            ...
            << " total_value_traded : "
            << etf_redemption_trade_er.total_value_traded
  ...
  for (auto it = etf_redemption_trade_er.constituent_stock.begin();
    ...
    std::cout << " security_id : " << it->security_id
              << " market_id : " << it->market_id << " qty : " << it->qty
              << " amt : " << it->amt << " price : " << it->price
              << " etf_trade_report_type : "
              << (int32_t)it->etf_trade_report_type << std::endl;
    i++;
  }
}

void DemoATPTradeHandler::OnRspBondDistributionTradeER(
    const ATPRspBondDistributionTradeERMsg &bond_distribution_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)bond_distribution_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)bond_distribution_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)bond_distribution_trade_er.ord_status
            << " cust_id : " << bond_distribution_trade_er.cust_id
            << " fund_account_id : "
            << bond_distribution_trade_er.fund_account_id
            ...
            << " total_value_traded : "
            << bond_distribution_trade_er.total_value_traded
            << " fee : " << bond_distribution_trade_er.fee << std::endl;
}

void DemoATPTradeHandler::OnRspStructuredFundTradeER(
    const ATPRspStructuredFundTradeERMsg &structured_fund_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)structured_fund_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)structured_fund_trade_er.business_type
            ...
            << " total_value_traded : "
            << structured_fund_trade_er.total_value_traded
            << " fee : " << structured_fund_trade_er.fee << std::endl;
}

void DemoATPTradeHandler::OnRspLOFTradeER(
    const ATPRspLOFTradeERMsg &lof_trade_er) {
...
void DemoATPTradeHandler::OnRspTibAfterHourAuctionTradeER(
    const ATPRspTibAfterHourAuctionTradeERMsg
        &tib_after_hour_auction_trade_er) {
  std::cout << "tib_after_hour_auction_trade_er : " << std::endl;
  std::cout << "partition : "
            << (int32_t)tib_after_hour_auction_trade_er.partition
            << " index : " << tib_after_hour_auction_trade_er.index
            << " business_type : "
            << (int32_t)tib_after_hour_auction_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)tib_after_hour_auction_trade_er.ord_status
            << " cust_id : " << tib_after_hour_auction_trade_er.cust_id
            << " fund_account_id : "
            << tib_after_hour_auction_trade_er.fund_account_id
            ...
            << " transact_time : "
            << tib_after_hour_auction_trade_er.transact_time
            ...
            << " total_value_traded : "
            << tib_after_hour_auction_trade_er.total_value_traded
            << " fee : " << tib_after_hour_auction_trade_er.fee
            << " cash_margin : " << tib_after_hour_auction_trade_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspPledgeInOrOutTradeER(
    const ATPRspPledgeInOrOutTradeERMsg &pledge_in_or_out_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)pledge_in_or_out_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)pledge_in_or_out_trade_er.business_type
            ...
            << " fund_account_id : "
            << pledge_in_or_out_trade_er.fund_account_id
            ...
            << " total_value_traded : "
            << pledge_in_or_out_trade_er.total_value_traded
...
void DemoATPTradeHandler::OnRspMaxOrderQueryResult(
  ...
  std::cout << "cust_id : " << max_order_query_result.cust_id
            ...
            << " query_result_code : "
            << max_order_query_result.query_result_code
            << " user_info : " << max_order_query_result.user_info
            << " max_order_qty : " << max_order_query_result.max_order_qty
            << " theoretical_order_qty : "
            << max_order_query_result.theoretical_order_qty << std::endl;
}

void DemoATPTradeHandler::OnRspOrderQueryResult(
    const ATPRspOrderQueryResultMsg &order_query_result) {
  ...
  for (auto it = order_query_result.order_array.begin();
    ...
    std::cout << " business_type : " << (int32_t)it->business_type
              ...
              << " account_id : " << it->account_id << " side : " << it->side
...
void DemoATPTradeHandler::OnRspQueryContractSpecificationsQueryResult(
    const ATPRspQueryContractSpecificationsResultMsg
        &contract_specifications_query_result) {
  std::cout << "contract_specifications_query_result : " << std::endl;
  std::cout << "cust_id : " << contract_specifications_query_result.cust_id
            << " fund_account_id : "
            << contract_specifications_query_result.fund_account_id
            << " account_id : "
            << contract_specifications_query_result.account_id
            << " client_seq_id : "
            << contract_specifications_query_result.client_seq_id
            << " query_result_code : "
            << contract_specifications_query_result.query_result_code
            << " user_info : " << contract_specifications_query_result.user_info
            << " last_index : "
            << contract_specifications_query_result.last_index
            << " total_num : " << contract_specifications_query_result.total_num
            << std::endl;
  // std::vector<APIOrderUnit>::iterator it;
  int i = 1;
  for (auto it = contract_specifications_query_result.order_array.begin();
    ...
    std::cout << " branch_id : " << it->branch_id
              ...
              << " market_id : " << it->market_id << " credit_identification : "
              << (int32_t)it->credit_identification
              ...
              << (int32_t)it->interest_rate_product
              ...
              << " unsettled_default_interest : "
              << it->unsettled_default_interest << std::endl;
    i++;
  }
}

void DemoATPTradeHandler::OnRspQueryCreditAmountQueryResult(
    const ATPRspQueryCreditAmountResultMsg &credit_amount_query_result) {
  std::cout << "credit_amount_query_result : " << std::endl;
  std::cout << "cust_id : " << credit_amount_query_result.cust_id
            << " fund_account_id : "
            << credit_amount_query_result.fund_account_id
            << " account_id : " << credit_amount_query_result.account_id
            << " client_seq_id : " << credit_amount_query_result.client_seq_id
            << " query_result_code : "
            << credit_amount_query_result.query_result_code
            << " user_info : " << credit_amount_query_result.user_info
            << " last_index : " << credit_amount_query_result.last_index
            << " total_num : " << credit_amount_query_result.total_num
            << std::endl;
  // std::vector<APIOrderUnit>::iterator it;
  int i = 1;
  for (auto it = credit_amount_query_result.order_array.begin();
    ...
    std::cout << " order_array_" << i << " : " << std::endl;
    std::cout << " branch_id : " << it->branch_id
              << " financing_security_amount : "
              << it->financing_security_amount
              << " financing_amount : " << it->financing_amount
              << " security_amount : " << it->security_amount
              << " financing_required_amount : "
              << it->financing_required_amount
              << " security_required_amount : " << it->security_required_amount
              << std::endl;
    i++;
  }
}

void DemoATPTradeHandler::OnRspQueryMarginUseableQueryResult(
    const ATPRspQueryMarginUseableResultMsg &margin_useable_query_result) {
  std::cout << "margin_useable_query_result : " << std::endl;
  std::cout << "cust_id : " << margin_useable_query_result.cust_id
            << " fund_account_id : "
            << margin_useable_query_result.fund_account_id
            << " account_id : " << margin_useable_query_result.account_id
            << " client_seq_id : " << margin_useable_query_result.client_seq_id
            << " query_result_code : "
            << margin_useable_query_result.query_result_code
            << " user_info : " << margin_useable_query_result.user_info
            << " branch_id : " << margin_useable_query_result.branch_id
            << " margin_useable_balance : "
            << margin_useable_query_result.margin_useable_balance << std::endl;
}

void DemoATPTradeHandler::OnRspQueryFundLiabilityQueryResult(
    const ATPRspQueryFundLiabilityResultMsg &fund_liability_query_result) {
  std::cout << "fund_liability_query_result : " << std::endl;
  std::cout
      << "cust_id : " << fund_liability_query_result.cust_id
      ...
      << " query_result_code : "
      << fund_liability_query_result.query_result_code
      ...
      << " real_time_balance : "
      << fund_liability_query_result.real_time_balance
      << " init_balance : " << fund_liability_query_result.init_balance
      << " settle_unpay_interest : "
      << fund_liability_query_result.settle_unpay_interest
      << " settle_unpay_penalty : "
      << fund_liability_query_result.settle_unpay_penalty
      ...
      << " crd_sell_required : "
      << fund_liability_query_result.crd_sell_required
      << " crd_buy_un_trade : " << fund_liability_query_result.crd_buy_un_trade
      << " crd_sell_un_trade : "
      << fund_liability_query_result.crd_sell_un_trade
      << " temp_add : " << fund_liability_query_result.temp_add
      << " temp_sub : " << fund_liability_query_result.temp_sub
      << " te_partition_no : "
      << (int32_t)fund_liability_query_result.te_partition_no
      << " private_amount_occupied: "
      << fund_liability_query_result.private_amount_occupied
      << " public_amount_occupied: "
      << fund_liability_query_result.public_amount_occupied
      << " private_amount_frozen: "
      << fund_liability_query_result.private_amount_frozen
      << " public_amount_frozen: "
      << fund_liability_query_result.public_amount_frozen << std::endl;
}

void DemoATPTradeHandler::OnRspQueryShareLiabilityQueryResult(
    const ATPRspQueryShareLiabilityResultMsg &share_liability_query_result) {
  std::cout << "share_liability_query_result : " << std::endl;
  std::cout << "cust_id : " << share_liability_query_result.cust_id
            << " fund_account_id : "
            << share_liability_query_result.fund_account_id
            << " account_id : " << share_liability_query_result.account_id
            << " client_seq_id : " << share_liability_query_result.client_seq_id
            << " query_result_code : "
            << share_liability_query_result.query_result_code
            << " user_info : " << share_liability_query_result.user_info
            << " last_index : " << share_liability_query_result.last_index
            << " total_num : " << share_liability_query_result.total_num
            << std::endl;
  // std::vector<APIOrderUnit>::iterator it;
  int i = 1;
...
void DemoATPTradeHandler::OnRspQueryContractSpecificationsManagerQueryResult(
    const ATPRspQueryContractSpecificationsManagerResultMsg
        &contract_specifications_manager_query_result) {
  std::cout << "contract_specifications_manager_query_result : " << std::endl;
  std::cout << "cust_id : "
            << contract_specifications_manager_query_result.cust_id
            << " fund_account_id : "
            << contract_specifications_manager_query_result.fund_account_id
            << " account_id : "
            << contract_specifications_manager_query_result.account_id
            << " client_seq_id : "
            << contract_specifications_manager_query_result.client_seq_id
            << " query_result_code : "
            << contract_specifications_manager_query_result.query_result_code
            << " user_info : "
            << contract_specifications_manager_query_result.user_info
            << " last_index : "
            << contract_specifications_manager_query_result.last_index
            << " total_num : "
            << contract_specifications_manager_query_result.total_num
            << std::endl;
  // std::vector<APIOrderUnit>::iterator it;
  int i = 1;
  for (auto it =
           contract_specifications_manager_query_result.order_array.begin();
       it != contract_specifications_manager_query_result.order_array.end();
       it++) {
    std::cout << " order_array_" << i << " : " << std::endl;
    std::cout
...
void DemoATPTradeHandler::OnRspQueryMarginUnderlyingQueryResult(
    const ATPRspQueryMarginUnderlyingResultMsg
        &margin_underlying_query_result) {
  std::cout << "margin_underlying_query_result : " << std::endl;
  std::cout << "cust_id : " << margin_underlying_query_result.cust_id
            << " fund_account_id : "
            << margin_underlying_query_result.fund_account_id
            << " account_id : " << margin_underlying_query_result.account_id
            << " client_seq_id : "
            << margin_underlying_query_result.client_seq_id
            << " query_result_code : "
            << margin_underlying_query_result.query_result_code
            << " user_info : " << margin_underlying_query_result.user_info <<

      " last_index : " << margin_underlying_query_result.last_index
            << " total_num : " << margin_underlying_query_result.total_num
            << std::endl;
  // std::vector<APIOrderUnit>::iterator it;
  int i = 1;
...
void DemoATPTradeHandler::OnRspQueryCreditInfoQueryResult(
    const ATPRspQueryCreditInfoResultMsg &credit_info_query_result) {
  ...
  std::cout << "cust_id : " << credit_info_query_result.cust_id
            ...
            << " query_result_code : "
            << credit_info_query_result.query_result_code
            << " user_info : " << credit_info_query_result.user_info <<

      " branch_id : " << credit_info_query_result.branch_id
            << " contrac_status : "
            << (int32_t)credit_info_query_result.contrac_status
            << " credit_rating : "
            << (int32_t)credit_info_query_result.credit_rating
            << " closeout_status : "
            << (int32_t)credit_info_query_result.closeout_status
            << " interest_product : "
            << (int32_t)credit_info_query_result.interest_product
            << " financing_guarantee_ratio : "
            << credit_info_query_result.financing_guarantee_ratio
            << " security_guarantee_ratio : "
            << credit_info_query_result.security_guarantee_ratio << std::endl;
}

void DemoATPTradeHandler::OnRspQueryFundAssetsInfoQueryResult(
    const ATPRspQueryFundAssetsInfoResultMsg &fund_assets_info_query_result) {
  std::cout << "fund_assets_info_query_result : " << std::endl;
  std::cout
      << "cust_id : " << fund_assets_info_query_result.cust_id
      ...
      << " query_result_code : "
      << fund_assets_info_query_result.query_result_code
      ...
      << " hold_market_value : "
      << fund_assets_info_query_result.hold_market_value
      << " total_assets : " << fund_assets_info_query_result.total_assets
      << " fund_debt : " << fund_assets_info_query_result.fund_debt
      << " share_debt_market_value : "
      << fund_assets_info_query_result.share_debt_market_value
      ...
      << " maintains_margin_ratio1 : "
      << fund_assets_info_query_result.maintains_margin_ratio1
      << " maintains_margin_ratio2 : "
      << fund_assets_info_query_result.maintains_margin_ratio2 << std::endl;
}

void DemoATPTradeHandler::OnRspTradeOrderQueryResult(
    const ATPRspTradeOrderQueryResultMsg &trade_order_query_result) {
  ...
  std::cout << "cust_id : " << trade_order_query_result.cust_id
            ...
            << " query_result_code : "
            << trade_order_query_result.query_result_code
            << " last_index : " << trade_order_query_result.last_index
            << " total_num : " << trade_order_query_result.total_num
            << std::endl;
  ...
  for (auto it = trade_order_query_result.order_array.begin();
    ...
    std::cout << " business_type : " << (int32_t)it->business_type
              ...
              << " cl_ord_id : " << it->cl_ord_id
              << " transact_time : " << it->transact_time
              << " last_px : " << it->last_px << " last_qty : " << it->last_qty
...
void DemoATPTradeHandler::OnRspFundQueryResult(
    const ATPRspFundQueryResultMsg &fund_query_result) {
  ...
  std::cout << "cust_id : " << fund_query_result.cust_id
            ...
            << " te_partition_no : "
            << (int32_t)fund_query_result.te_partition_no
            << " credit_sell_frozen : " << fund_query_result.credit_sell_frozen
            << std::endl;
}

void DemoATPTradeHandler::OnRspShareQueryResult(
    const ATPRspShareQueryResultMsg &share_query_result) {
...
void DemoATPTradeHandler::OnRspIPOQtyQueryResult(
    const ATPRspIPOQtyQueryResultMsg &ipo_qty_query_result) {
  ...
  for (auto it = ipo_qty_query_result.order_array.begin();
    ...
    std::cout << " order_array_" << i << " : " << std::endl;
    std::cout << " market_id : " << it->market_id
              << " subscription_quota : " << it->subscription_quota
              << std::endl;
    i++;
  }
}

void DemoATPTradeHandler::OnRspAccountContractShareQueryResult(
    const ATPRspAccountContractShareQueryResultMsg
        &account_contract_share_query_result) {
  std::cout << "account_contract_share_query_result : " << std::endl;
  std::cout << "cust_id:" << account_contract_share_query_result.cust_id
            << std::endl;
  std::cout << "fund_account_id:"
            << account_contract_share_query_result.fund_account_id << std::endl;
  std::cout << "account_id:" << account_contract_share_query_result.account_id
            << std::endl;
  std::cout << "client_seq_id:"
            << account_contract_share_query_result.client_seq_id << std::endl;
  std::cout << "query_result_code:"
            << account_contract_share_query_result.query_result_code
            << std::endl;
  std::cout << "user_info:" << account_contract_share_query_result.user_info
            << std::endl;
  std::cout << "extra_data:" << account_contract_share_query_result.extra_data
            << std::endl;
  std::cout << "account_sub_code:"
            << account_contract_share_query_result.account_sub_code
            << std::endl;
  std::cout << "last_index:" << account_contract_share_query_result.last_index
            << std::endl;
  std::cout << "total_num:" << account_contract_share_query_result.total_num
            << std::endl;
  ...
  for (auto it = account_contract_share_query_result.contract_array.begin();
    ...
    std::cout << "init_total_position_value:" << it->init_total_position_value
              << std::endl;
    std::cout << "init_position_value:" << it->init_position_value << std::endl;
    std::cout << "tatol_position_value:" << it->tatol_position_value
              << std::endl;
    ...
    std::cout << "close_position_value:" << it->close_position_value
              << std::endl;
    std::cout << "buy_frozen_value:" << it->buy_frozen_value << std::endl;
    std::cout << "exercise_qty:" << it->exercise_qty << std::endl;
    std::cout << "buy_amt:" << it->buy_amt << std::endl;
    std::cout << "init_position_used_amt:" << it->init_position_used_amt
              << std::endl;
...
void DemoATPTradeHandler::OnRspAccountContractFundQueryResult(
    const ATPRspAccountContractFundQueryResultMsg
        &account_contract_fund_query_result) {
  std::cout << "account_contract_fund_query_result : " << std::endl;
  std::cout << "cust_id : " << account_contract_fund_query_result.cust_id
            << " fund_account_id : "
            << account_contract_fund_query_result.fund_account_id
            << " account_id : " << account_contract_fund_query_result.account_id
            << " client_seq_id : "
            << account_contract_fund_query_result.client_seq_id
            << " query_result_code : "
            << account_contract_fund_query_result.query_result_code
            << " user_info : " << account_contract_fund_query_result.user_info
            << " init_total_amt : "
            << account_contract_fund_query_result.init_total_amt
            << " init_available_amt : "
            << account_contract_fund_query_result.init_available_amt
            << " available_amt : "
            << account_contract_fund_query_result.available_amt
            << " frozen_amt : " << account_contract_fund_query_result.frozen_amt
            << std::endl;
}

void DemoATPTradeHandler::OnRspCollectQueryResult(
    const ATPRspCollectQueryResultMsg &collect_query_result) {
  ...
  std::cout << "cust_id : " << collect_query_result.cust_id
            ...
            << " all_buy_total_value_traded : "
            << collect_query_result.all_buy_total_value_traded
            << " all_sell_avg_price : "
            << collect_query_result.all_sell_avg_price
            << " all_sell_cum_qty : " << collect_query_result.all_sell_cum_qty
            << " all_sell_total_value_traded : "
            << collect_query_result.all_sell_total_value_traded
            << " all_total_value_traded : "
            << collect_query_result.all_total_value_traded << std::endl;
...
void DemoATPTradeHandler::OnRspTIBIPOQtyQueryResult(
    const ATPRspTIBIPOQtyQueryResultMsg &tib_ipo_qty_query_result) {
  ...
  std::cout << "cust_id : " << tib_ipo_qty_query_result.cust_id
            ...
            << " query_result_code : "
            << tib_ipo_qty_query_result.query_result_code
            << " user_info : " << tib_ipo_qty_query_result.user_info
            << std::endl;
  // std::vector<APIIPOQtyUnit>::iterator it;
  int i = 1;
...
void DemoATPTradeHandler::OnRspCoverMaxOrderQtyResultQueryResult(
    const ATPRspCoverMaxOrderQtyResultQueryResultMsg
        &cover_max_order_qty_result_query_result) {
  ...
  std::cout << "cust_id : " << cover_max_order_qty_result_query_result.cust_id
            << " fund_account_id : "
            << cover_max_order_qty_result_query_result.fund_account_id
            << " account_id : "
            << cover_max_order_qty_result_query_result.account_id
            << " client_seq_id : "
            << cover_max_order_qty_result_query_result.client_seq_id
            << " query_result_code : "
            << cover_max_order_qty_result_query_result.query_result_code
            << " user_info : "
            << cover_max_order_qty_result_query_result.user_info
            << " max_order_qty : "
            << cover_max_order_qty_result_query_result.max_order_qty
            << " theoretical_order_qty : "
            << cover_max_order_qty_result_query_result.theoretical_order_qty
            << std::endl;
}

void DemoATPTradeHandler::OnRspSyncBizFinish(
    const ATPRspSyncBizFinishOtherMsg &sync_biz_finish) {
  std::cout << "sync_biz_finish : " << std::endl;
  std::cout << "client_seq_id : " << sync_biz_finish.client_seq_id << std::endl;
}

void DemoATPTradeHandler::OnRspCustLoginResp(
    const ATPRspCustLoginRespOtherMsg &cust_login_resp) {
  ...
  std::cout << "client_seq_id : " << cust_login_resp.client_seq_id
            ...
            << " permisson_error_code : "
            << cust_login_resp.permisson_error_code
  ...
  for (auto it = cust_login_resp.fund_account_array.begin();
    ...
    for (auto it_1 = it->account_array.begin(); it_1 != it->account_array.end();
         it_1++) {
...
void DemoATPTradeHandler::OnRspCustLogoutResp(
    const ATPRspCustLogoutRespOtherMsg &cust_logout_resp) {
  ...
  std::cout << "time : " << cust_logout_resp.time
            ...
            << " permisson_error_code : "
            << (int32_t)cust_logout_resp.permisson_error_code
            << " user_info : " << cust_logout_resp.user_info << std::endl;
}

void DemoATPTradeHandler::OnRspExtFundTransferResult(
    const ATPRspExtFundTransferResultOtherMsg &ext_fund_transfer_result) {
  std::cout << "ext_fund_transfer_result : " << std::endl;
  std::cout
      << "partition : " << (int32_t)ext_fund_transfer_result.partition
      ...
      << " unusual_frozen_cancel : "
      << ext_fund_transfer_result.unusual_frozen_cancel
...
void DemoATPTradeHandler::OnRspExtRepayResult(
    const ATPRspExtRepayResultOtherMsg &ext_repay_result) {
...
void DemoATPTradeHandler::OnRspBizRejection(
    const ATPRspBizRejectionOtherMsg &biz_rejection) {
...
void DemoATPTradeHandler::OnRspAfterHoursPricingTradeER(
    const ATPRspAfterHoursPricingTradeERMsg &after_hours_pricing_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)after_hours_pricing_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)after_hours_pricing_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)after_hours_pricing_trade_er.ord_status
            << " cust_id : " << after_hours_pricing_trade_er.cust_id
            << " fund_account_id : "
            << after_hours_pricing_trade_er.fund_account_id
            ...
            << " total_value_traded : "
            << after_hours_pricing_trade_er.total_value_traded
            << " fee : " << after_hours_pricing_trade_er.fee
            << " price_property : "
            << (int32_t)after_hours_pricing_trade_er.price_property
            << " cash_margin : " << after_hours_pricing_trade_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspBlockTradeTransactionTradeER(
    const ATPRspBlockTradeTransactionTradeERMsg
        &block_trade_transaction_trade_er) {
  std::cout << "block_trade_transaction_trade_er : " << std::endl;
  std::cout << "partition : "
            << (int32_t)block_trade_transaction_trade_er.partition
            << " index : " << block_trade_transaction_trade_er.index
            << " business_type : "
            << (int32_t)block_trade_transaction_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)block_trade_transaction_trade_er.ord_status
            << " cust_id : " << block_trade_transaction_trade_er.cust_id
            << " fund_account_id : "
            << block_trade_transaction_trade_er.fund_account_id
            ...
            << " transact_time : "
            << block_trade_transaction_trade_er.transact_time
            ...
            << " total_value_traded : "
            << block_trade_transaction_trade_er.total_value_traded
            << " fee : " << block_trade_transaction_trade_er.fee
            << " counter_party_pbu_id : "
            << block_trade_transaction_trade_er.counter_party_pbu_id
            << " counter_party_account_id : "
            << block_trade_transaction_trade_er.counter_party_account_id
            << " trd_sub_type : "
            << (int32_t)block_trade_transaction_trade_er.trd_sub_type
            << " confirm_id : " << block_trade_transaction_trade_er.confirm_id
            << " cash_margin : " << block_trade_transaction_trade_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspBlockTradePricingTradeER(
    const ATPRspBlockTradePricingTradeERMsg &block_trade_pricing_trade_er) {
  ...
  std::cout << "partition : " << (int32_t)block_trade_pricing_trade_er.partition
            ...
            << " business_type : "
            << (int32_t)block_trade_pricing_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)block_trade_pricing_trade_er.ord_status
            << " cust_id : " << block_trade_pricing_trade_er.cust_id
            << " fund_account_id : "
            << block_trade_pricing_trade_er.fund_account_id
            ...
            << " total_value_traded : "
            << block_trade_pricing_trade_er.total_value_traded
            ...
            << " cash_margin : " << block_trade_pricing_trade_er.cash_margin
            << std::endl;
}

void DemoATPTradeHandler::OnRspExtOptionFundTransferResult(
    const ATPRspOptionFundTransferResultOtherMsg &result) {
  ...
  std::cout << "init_exercise_assign:" << result.init_exercise_assign
            << std::endl;
  std::cout << "init_exercise_frozen:" << result.init_exercise_frozen
            << std::endl;
  ...
  std::cout << "can_transfer_in_amt:" << result.can_transfer_in_amt
            << std::endl;
  std::cout << "user_info:" << result.user_info << std::endl;
  std::cout << "extra_data:" << result.extra_data << std::endl;
}

void DemoATPTradeHandler::OnRspExtQueryResultExerciseProfitLoss(
    const ATPRspExtQueryResultExerciseProfitLossMsg &result) {
  ...
  std::cout << "exercise_profit_loss:" << result.exercise_profit_loss
            << std::endl;
  std::cout << "exercise_contract_buy_cost:"
            << result.exercise_contract_buy_cost << std::endl;
}

void DemoATPTradeHandler::OnRspHKStocksThroughAuctionTradeER(
    const ATPRspHKStocksThroughAuctionTradeERMsg
        &hkstocksthrough_auction_trade_er) {
  std::cout << "hkstocksthrough_auction_trade_er : " << std::endl;
  std::cout << "partition : "
            << (int32_t)hkstocksthrough_auction_trade_er.partition
            << " index : " << hkstocksthrough_auction_trade_er.index
            << " business_type : "
            << (int32_t)hkstocksthrough_auction_trade_er.business_type
            ...
            << " ord_status : "
            << (int32_t)hkstocksthrough_auction_trade_er.ord_status
            << " cust_id : " << hkstocksthrough_auction_trade_er.cust_id
            << " fund_account_id : "
            << hkstocksthrough_auction_trade_er.fund_account_id
            ...
            << " transact_time : "
            << hkstocksthrough_auction_trade_er.transact_time
            ...
            << " total_value_traded : "
            << hkstocksthrough_auction_trade_er.total_value_traded
            << " fee : " << hkstocksthrough_auction_trade_er.fee
            << " cny_net_total_value_trade : "
            << hkstocksthrough_auction_trade_er.cny_net_total_value_trade
            << " cny_fee:" << hkstocksthrough_auction_trade_er.cny_fee
            << std::endl;
}

void DemoATPTradeHandler::OnRspExtQueryResultCombinExerciseMaxOrderQty(
    const ATPRspExtQueryResultCombinExerciseMaxOrderQtyMsg &result) {
  std::cout << "OnRspExtQueryResultCombinExerciseMaxOrderQty:\n";
  std::cout << "cust_id:" << result.cust_id << std::endl; ///< 客户号ID
  std::cout << "fund_account_id:" << result.fund_account_id
            << std::endl;                                       ///< 资金账户ID
  std::cout << "account_id:" << result.account_id << std::endl; ///< 账户ID
  std::cout << "client_seq_id:" << result.client_seq_id
            << std::endl; ///< 用户系统消息序号
  std::cout << "query_result_code:" << result.query_result_code
            << std::endl;                                     ///< 查询结果代码
  std::cout << "user_info:" << result.user_info << std::endl; ///< 用户私有信息
  std::cout << "max_order_qty:" << result.max_order_qty
            << std::endl; ///< 最大可委托数
  std::cout << "theoretical_order_qty:" << result.theoretical_order_qty
            << std::endl; ///< 理论可委托数
}

void DemoATPTradeHandler::OnRspExtQueryResultCombinExerciseProfitLoss(
    const ATPRspExtQueryResultCombinExerciseProfitLossMsg &result) {
  ...
  std::cout << "combin_exercise_profit_loss:"
            << result.combin_exercise_profit_loss
            << std::endl; ///< 合并行权盈亏
  std::cout << "combin_exercise_contract_buy_cost:"
            << result.combin_exercise_contract_buy_cost
            << std::endl; ///< 合并行权买入成本
}

void DemoATPTradeHandler::OnRspThirdPartPassThroughResult(
    const ATPRspThirdPartPassThroughResultMsg &result) {
...
void DemoATPTradeHandler::OnRspBankSecuritiesFundTransferResult(
    const ATPRspBankSecuritiesFundTransferResultOtherMsg &result) {
  std::cout << "OnRspBankSecuritiesFundTransferResult:\n";
  std::cout << "user_info:" << result.user_info << std::endl;
  std::cout << "transact_time:" << result.transact_time << std::endl;
  std::cout << "transfer_serial_no:" << result.transfer_serial_no << std::endl;
  std::cout << "bank_transfer_serial_no:" << result.bank_transfer_serial_no
            << std::endl;
  std::cout << "client_seq_id:" << result.client_seq_id << std::endl;
  std::cout << "reject_reason_code:" << result.reject_reason_code << std::endl;
  std::cout << "extra_data:" << result.extra_data << std::endl;
