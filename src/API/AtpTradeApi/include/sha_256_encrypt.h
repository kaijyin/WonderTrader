 ...
 */
ENCRYPT_API void *EncryptedPasswordSha256(const char *buf, unsigned int len,
 ...
 */
ENCRYPT_API void *DecryptPasswordSha256(const char *buf, unsigned int len,
                                        unsigned int *out_len, void *ext_buffer,
                                        unsigned int ext_buffer_len);
}
