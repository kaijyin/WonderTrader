...
public:
  ...
  virtual const char *watch_param(const char *name,
                                  const char *initVal = "") override;
  ...
  virtual const char *read_param(const char *name,
  ...
  virtual const char *sync_param(const char *name, const char *initVal = "",
                                 bool bForceWrite = false) override;
  virtual double *sync_param(const char *name, double initVal = 0,
                             bool bForceWrite = false) override;
  virtual uint32_t *sync_param(const char *name, uint32_t initVal = 0,
                               bool bForceWrite = false) override;
  virtual uint64_t *sync_param(const char *name, uint64_t initVal = 0,
                               bool bForceWrite = false) override;
  virtual int32_t *sync_param(const char *name, int32_t initVal = 0,
                              bool bForceWrite = false) override;
  virtual int64_t *sync_param(const char *name, int64_t initVal = 0,
                              bool bForceWrite = false) override;
...
private:
  ...
  typedef struct _Position {
    ...
    _Position()
        : _volume(0), _valid_idx(0), _total_profit(0), _opencost(0),
          _dynprofit(0) {}
  } PosInfo;
