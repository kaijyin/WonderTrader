...
public:
   ...
   *	分类输出
   */
  static void log_raw_by_cat(const char *catName, WTSLogLevel ll,
                             const char *message);
...
public:
  ...
  template <typename... Args>
  static void log_by_cat(const char *catName, WTSLogLevel ll,
  ...
  template <typename... Args>
  static void log_by_cat_prefix(const char *catName, WTSLogLevel ll,
                                const char *format, const Args &...args) {
    if (m_logLevel > ll || m_bStopped)
      return;
  ...
  template <typename... Args>
  static void log_dyn(const char *patttern, const char *catName, WTSLogLevel ll,
                      const char *format, const Args &...args) {
    if (m_logLevel > ll || m_bStopped)
      return;
  ...
  template <typename... Args>
  static void log_dyn_prefix(const char *patttern, const char *catName,
                             WTSLogLevel ll, const char *format,
                             const Args &...args) {
    if (m_logLevel > ll || m_bStopped)
      return;
...
public:
  static void init(const char *propFile = "logcfg.json", bool isFile = true,
