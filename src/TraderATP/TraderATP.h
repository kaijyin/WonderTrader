...
public:
   ...
   */
  virtual void
  OnRspFundQueryResult(const ATPRspFundQueryResultMsg &msg) override;
   ...
   */
  virtual void
  OnRspShareQueryResult(const ATPRspShareQueryResultMsg &msg) override;
  ...
  virtual void OnRspTradeOrderQueryResult(
      const ATPRspTradeOrderQueryResultMsg &msg) override;
   ...
   */
  virtual void
  OnRspOrderQueryResult(const ATPRspOrderQueryResultMsg &msg) override;
...
private:
  ...
  inline WTSOrderInfo *
  makeOrderInfo(const ATPRspOrderStatusAckMsg *order_status_ack);
  inline WTSTradeInfo *
  makeTradeRecord(const ATPRspCashAuctionTradeERMsg *cash_auction_trade_er);
