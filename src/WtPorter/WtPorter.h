...
EXPORT_FLAG void register_exec_callbacks(FuncExecInitCallback cbInit,
...
// 选股策略接口
#pragma region "SEL接口"
EXPORT_FLAG CtxHandler create_sel_context(const char *name, uint32_t date,
