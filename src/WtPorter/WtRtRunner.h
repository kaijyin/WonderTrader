...
public:
  ...
  uint32_t createHftContext(const char *name, const char *trader, bool bAgent,
                            int32_t slippage);
  uint32_t createSelContext(const char *name, uint32_t date, uint32_t time,
                            const char *period, int32_t slippage,
...
public:
  ...
  void hft_on_position(uint32_t cHandle, const char *stdCode, bool isLong,
