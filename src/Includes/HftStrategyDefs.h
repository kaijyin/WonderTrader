...
public:
   ...
   *	tick回调
   */
  virtual void on_tick(IHftStraCtx *ctx, const char *code,
                       WTSTickData *newTick) {}

  /*
   *	委托队列回调
   */
  virtual void on_order_queue(IHftStraCtx *ctx, const char *code,
                              WTSOrdQueData *newOrdQue) {}

  /*
   *	委托明细回调
   */
  virtual void on_order_detail(IHftStraCtx *ctx, const char *code,
                               WTSOrdDtlData *newOrdDtl) {}

  /*
   *	逐笔成交回调
   */
  virtual void on_transaction(IHftStraCtx *ctx, const char *code,
...
//////////////////////////////////////////////////////////////////////////
// 策略工厂接口
typedef void (*FuncEnumHftStrategyCallback)(const char *factName,
