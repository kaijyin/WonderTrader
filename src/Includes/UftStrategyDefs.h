...
public:
   ...
   *	tick推送
   */
  virtual void on_tick(IUftStraCtx *ctx, const char *stdCode,
                       WTSTickData *newTick) {}

  /*
   *	委托队列推送
   */
  virtual void on_order_queue(IUftStraCtx *ctx, const char *stdCode,
                              WTSOrdQueData *newOrdQue) {}

  /*
   *	逐笔委托推送
   */
  virtual void on_order_detail(IUftStraCtx *ctx, const char *stdCode,
                               WTSOrdDtlData *newOrdDtl) {}

  /*
   *	逐笔成交推送
   */
  virtual void on_transaction(IUftStraCtx *ctx, const char *stdCode,
   ...
   *	@times		重采样倍数
   */
  virtual void on_bar(IUftStraCtx *ctx, const char *stdCode, const char *period,
...
//////////////////////////////////////////////////////////////////////////
// 策略工厂接口
typedef void (*FuncEnumUftStrategyCallback)(const char *factName,
                                            const char *straName, bool isLast);
