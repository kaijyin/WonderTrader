...
typedef struct _TradeStatInfo {
  ...
  _TradeStatInfo() { memset(this, 0, sizeof(_TradeStatInfo)); }
} TradeStatInfo;
...
public:
  ...
  inline double closet_volume_long() const {
    return _trd_stat_info.l_closetvol;
  }
  ...
  inline double closet_volume_short() const {
    return _trd_stat_info.s_closetvol;
  }
  ...
  inline uint32_t total_cancels() const {
    return _trd_stat_info.b_cancels + _trd_stat_info.s_cancels;
  }
  inline uint32_t total_orders() const {
    return _trd_stat_info.b_orders + _trd_stat_info.s_orders;
  }
...
typedef struct _WTSFundStruct {
  ...
  typedef struct _DynBalPair {
    ...
    _DynBalPair() { memset(this, 0, sizeof(_DynBalPair)); }
  } DynBalPair;
...
public:
  ...
  double max_md_dyn_balance() const {
    return _fund_info._max_md_dyn_bal._dyn_balance;
  }
  double min_md_dyn_balance() const {
    return _fund_info._min_md_dyn_bal._dyn_balance;
  }
  ...
  uint32_t max_md_dynbal_date() const {
    return _fund_info._max_md_dyn_bal._date;
  }
  uint32_t min_md_dynbal_date() const {
    return _fund_info._min_md_dyn_bal._date;
  }
