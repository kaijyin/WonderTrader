 ...
 * \param Scheduler A task container which determines how tasks are scheduled.
 * It is guaranteed that this container is accessed only by one thread at a
 * time. The scheduler shall not throw exceptions.
 *
