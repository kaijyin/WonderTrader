 ...
 *
 * The class is a wrapper for a volatile pointer. It enables synchronized access
 * to the internal pointer by locking the passed mutex. locking_ptr is based on
 * Andrei Alexandrescu's LockingPtr. For more information see article "volatile
 * - Multithreaded Programmer's Best Friend" by A. Alexandrescu.
 *
 *
 ...
 *
 * This class is a wrapper for a volatile pointer. It enables synchronized
 * access to the internal pointer by locking the passed mutex.
 */
template <typename T, typename Mutex> class locking_ptr : private noncopyable {
