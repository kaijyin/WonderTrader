 ...
 * to the tasks. 	Fundamentally the container determines the order the
 * tasks are processed by the thread pool. The task containers need not to be
 ...
 *
 */
template <typename Task = task_func> class fifo_scheduler {
public:
 ...
 *
 */
template <typename Task = task_func> class lifo_scheduler {
public:
  typedef Task task_type; //!< Indicates the scheduler's task type.
 ...
 *
 */
template <typename Task = prio_task_func> class prio_scheduler {
public:
  typedef Task task_type; //!< Indicates the scheduler's task type.
