...
public:
  //////////////////////////////////////////////////////////////////////////
  // IMatchSink
  virtual void handle_trade(uint32_t localid, const char *stdCode, bool isBuy,
                            double vol, double fireprice, double price,
                            uint64_t ordTime) override;
  virtual void handle_order(uint32_t localid, const char *stdCode, bool isBuy,
                            double leftover, double price, bool isCanceled,
                            uint64_t ordTime) override;
  virtual void handle_entrust(uint32_t localid, const char *stdCode,
  ...
  virtual OrderIDs cancel(const char *stdCode, bool isBuy,
