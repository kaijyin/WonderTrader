...
public:
  ...
  virtual void on_tick(IUftStraCtx *ctx, const char *code,
                       WTSTickData *newTick) override;

  virtual void on_bar(IUftStraCtx *ctx, const char *code, const char *period,
                      uint32_t times, WTSBarStruct *newBar) override;

  virtual void on_trade(IUftStraCtx *ctx, uint32_t localid, const char *stdCode,
                        bool isLong, uint32_t offset, double qty,
  ...
  virtual void on_order(IUftStraCtx *ctx, uint32_t localid, const char *stdCode,
                        ...
                        double leftQty, double price, bool isCanceled) override;
