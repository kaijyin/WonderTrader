...
public:
  ...
  virtual void OnRspQryInvestorPosition(
      ...
      CUstpFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) override;
  ...
  virtual void OnRtnInstrumentStatus(
      CUstpFtdcInstrumentStatusField *pInstrumentStatus) override;
...
protected:
  ...
  WTSDirectionType wrapDirectionType(TUstpFtdcDirectionType dirType,
                                     TUstpFtdcOffsetFlagType offType);
