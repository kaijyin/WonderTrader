...
public:
  ...
  typedef enum { ST_BROADCAST } StatType;

  typedef enum { UF_Recv = 0x0001, UF_Send = 0x0002 } UpdateFlag;

public:
  void updateStatInfo(StatType sType, uint32_t recvPacks, uint32_t sendPacks,
                      uint64_t sendBytes) {
